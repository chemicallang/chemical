...
struct FuncDeclAttributes {
    ...
    /**
     * true when function is generated by the compiler
     */
...
public:
    ...
    inline bool is_generated_fn() {
        return attrs.is_generated;
    }
    ...
    void ensure_constructor(ASTAllocator& allocator, ASTDiagnoser& diagnoser, ASTNode* def);
