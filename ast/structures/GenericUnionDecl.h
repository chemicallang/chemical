...
public:
     ...
     */
    std::vector<UnionDef*> instantiations;
    ...
    ) : GenericMembersDecl(ASTNodeKind::GenericUnionDecl, parent_node, location), master_impl(master_impl) {
     ...
     */
    UnionDef* register_generic_args(GenericInstantiatorAPI& instantiator, std::vector<BaseType*>& types);
