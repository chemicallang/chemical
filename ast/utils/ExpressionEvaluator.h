...
namespace ExpressionEvaluators {
    ...
    const std::unordered_map<int, EvaluatorFn> ExpressionEvaluatorsMap = {
            ...
            {computeIntToInt(Operation::Addition),                 [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<IntValue>()) IntValue(v1->get_the_int() + v2->get_the_int(), nullptr);
            }},
            ...
            {computeIntToInt(Operation::IsEqual),                  [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_int() == v2->get_the_int(), nullptr);
            }},
            ...
            {computeIntToInt(Operation::PostfixIncrement),         [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<IntValue>()) IntValue(v1->get_the_int() + 1, nullptr);
            }},
            ...
            {computeBoolToBool(Operation::Addition),               [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_bool() + v2->get_the_bool(), nullptr);
            }},
            ...
            {computeBoolToBool(Operation::Division),               [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<IntValue>()) IntValue(v1->get_the_bool() / v2->get_the_bool(), nullptr);
            }},
            ...
            {computeCharToChar(Operation::Addition),               [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<IntValue>()) IntValue(v1->get_the_char() + v2->get_the_char(), nullptr);
            }},
            ...
            {computeCharToChar(Operation::IsEqual),                [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_char() == v2->get_the_char(), nullptr);
            }},
            ...
            {computeFloatToFloat(Operation::Addition),             [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new FloatValue(v1->get_the_float() + v2->get_the_float(), nullptr);
            }},
...
//        return new (scope.allocate<IntValue>()) IntValue(v1->get_the_float() % v2->get_the_float());
//    }},

            //    (float == float) -> bool
            {computeFloatToFloat(Operation::IsEqual),              [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_float() == v2->get_the_float(), nullptr);
            }},
...
//    }},
            ...
            {computeDoubleToDouble(Operation::Addition),           [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<DoubleValue>()) DoubleValue(v1->get_the_double() + v2->get_the_double(), nullptr);
            }},
...
//        return new (scope.allocate<IntValue>()) IntValue(v1->get_the_double() % v2->get_the_double());
//    }},

            //    (double == double) -> bool
            {computeDoubleToDouble(Operation::IsEqual),            [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_double() == v2->get_the_double(), nullptr);
            }},
...
//    }},
            ...
            {computeStrToStr(Operation::Addition),                 [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<StringValue>()) StringValue(v1->get_the_string() + v2->get_the_string(), nullptr);
            }},

            //    (string == string) -> bool
            {computeStrToStr(Operation::IsEqual),                  [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_string() == v2->get_the_string(), nullptr);
            }},
            ...
            {computeIntToFloat(Operation::Addition),               [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<FloatValue>()) FloatValue(v1->get_the_int() + v2->get_the_float(), nullptr);
            }},
...
//        return new (scope.allocate<FloatValue>()) FloatValue(v1->get_the_int() % v2->get_the_float());
//    }},

            //    (int == float) -> bool
            {computeIntToFloat(Operation::IsEqual),                [](InterpretScope& scope, Value *v1, Value *v2) -> Value * {
                return new (scope.allocate<BoolValue>()) BoolValue(v1->get_the_int() == v2->get_the_float(), nullptr);
            }},
