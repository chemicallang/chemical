...
void std_stdResult__cgs__0delete(struct std_stdResult__cgs__0* self);
struct std_stdallocAllocError {
	int __chx__vt_621827;
	union {
		struct {
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_i32(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_i64(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_u8(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdstringto_i16(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_i32(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_i64(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_u8(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
void std_stdu16stringsubstr(struct std_stdu16string* __chx_struct_ret_param_xx, struct std_stdu16string*const self, size_t start, size_t len){
	struct std_stdu16string result = (*({ struct std_stdu16string __chx__lv__8; std_stdu16stringempty_str(&__chx__lv__8); &__chx__lv__8; }));
	...
	buf[real_len] = 0;
	struct std_stdu16string __chx__lv__10 = (*({ struct std_stdu16string __chx__lv__11; std_stdu16stringconstructor(&__chx__lv__11, buf, real_len); &__chx__lv__11; }));
	*__chx_struct_ret_param_xx = result;
	std_stdu16stringdelete(&__chx__lv__10);
	return;
}
void std_stdu16stringto_utf8(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdu16string*const self){
	size_t n = std_stdu16stringsize(self);
	if((n == 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__12; std_stdstringempty_str(&__chx__lv__12); &__chx__lv__12; }));
		return;
	}
	unsigned long out_cap = ((n * 3) + 1);
	struct std_stdstring out = (*({ struct std_stdstring __chx__lv__13; std_stdstringempty_str(&__chx__lv__13); &__chx__lv__13; }));
...
int std_stdu16stringfind(struct std_stdu16string*const self, struct std_stdu16string* sub){
	...
	if((m == 0)){
		const int __chx__lv__16 = 0;
		if(__chx__lv__15) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__16;
	}
	if((m > n)){
		const int __chx__lv__17 = -1;
		if(__chx__lv__15) {
			std_stdu16stringdelete(sub);
		}
	...
	while(((i + m) <= n)) {
		...
		if((j == m)){
			const int __chx__lv__18 = ((int) i);
			if(__chx__lv__15) {
				std_stdu16stringdelete(sub);
			}
			return __chx__lv__18;
		}
		i = (i + 1);
	}
	const int __chx__lv__19 = -1;
	if(__chx__lv__15) {
		std_stdu16stringdelete(sub);
	}
	return __chx__lv__19;
}
_Bool std_stdu16stringstarts_with(struct std_stdu16string*const self, struct std_stdu16string* prefix){
...
static void std_stdOsStringmake2(struct std_stdOsString* this, struct std_stdstring*const utf8){
	...
	*this = (struct std_stdOsString){ 
		.data_ = (*({ struct std_stdstring __chx__lv__29; std_stdstringcopy(&__chx__lv__29, utf8); &__chx__lv__29; }))
	};
	return;
}
static void std_stdOsStringfrom_utf8(struct std_stdOsString* __chx_struct_ret_param_xx, struct std_stdstring*const utf8){
	*__chx_struct_ret_param_xx = (*({ struct std_stdOsString __chx__lv__30; std_stdOsStringmake2(&__chx__lv__30, utf8); &__chx__lv__30; }));
	return;
}
static size_t std_stdOsStringsize(struct std_stdOsString*const self){
...
void std_stdallocGlobalAllocatoralloc_zeroed(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout){
	struct std_stdResult__cgs__1 result = (*({ struct std_stdResult__cgs__1 __chx__lv__33; std_stdallocGlobalAllocatoralloc(&__chx__lv__33, self, ({ struct std_stdallocLayout __chx__lv__34 = *layout; &__chx__lv__34; })); &__chx__lv__33; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__1* __chx__lv__35 = &result;
	memset(__chx__lv__35->Ok.value, 0, layout->size);
	*__chx_struct_ret_param_xx = result;
	return;
}
void std_stdallocGlobalAllocatorcheck_leaks(struct std_stdallocGlobalAllocator*const self){
...
void std_stdallocalloc_zeroed_bytes(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, size_t size){
	struct std_stdResult__cgs__1 result = (*({ struct std_stdResult__cgs__1 __chx__lv__36; std_stdallocalloc_bytes(&__chx__lv__36, size); &__chx__lv__36; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__1* __chx__lv__37 = &result;
	memset(__chx__lv__37->Ok.value, 0, size);
	*__chx_struct_ret_param_xx = result;
	return;
}
...
static void __chemda_379_0(void* this){
}
cstd_usize std_stdconcurrenthardware_threads(){
...
static const void* std_stdconcurrentworker_main(const void* arg){
	...
	while(1) {
		...
		if((std_stdvector__cgs__0size(&P->q) > 0)){
			...
			struct std_stdconcurrentTask t = (*({ struct std_stdconcurrentTask __chx__lv__38; std_stdreplace__cfg_0(&__chx__lv__38, &*first_ele, &(struct std_stdconcurrentTask){ 
				.f = *({ __chemical_fat_pointer__* __chemda_379_0_pair = &(__chemical_fat_pointer__){__chemda_379_0,NULL}; &(*({ struct std_stddefault_function_instance __chx__lv__39; std_stddefault_function_instancemake2(&__chx__lv__39, __chemda_379_0_pair->first, __chemda_379_0_pair->second, ((std_stddestructor_type) NULL), 0, 0); &__chx__lv__39; })); })
			}); &__chx__lv__38; }));
		...
		if((opt.__chx__vt_621827 == 0)){
			struct std_stdOption__cgs__1* __chx__lv__40 = &opt;
			({ struct std_stddefault_function_instance* __chx__lv__41 = &__chx__lv__40->Some.value.f; ((void(*)(void*))std_stddefault_function_instanceget_fn_ptr(__chx__lv__41))(std_stddefault_function_instanceget_data_ptr(__chx__lv__41)); });
		}
	}
	return NULL;
}
...
void std_stdconcurrentThreadPoolsubmit_void(struct std_stdconcurrentThreadPool*const self, std_stdfunction* f){
	...
	std_stdconcurrentPoolDatasubmit_void(self->data, ({ __chx__lv__43 = false; &*f; }));
	if(__chx__lv__43) {
		std_stddefault_function_instancedelete(f);
	}
}
void std_stdconcurrentThreadPooldelete(struct std_stdconcurrentThreadPool*const self){
	struct std_stdconcurrentPoolData*__chx__lv__44 = self->data;
	
	std_stdconcurrentPoolDatadelete(__chx__lv__44);
	free(__chx__lv__44);
	__chx__dstctr_clnup_blk__:{
	}
}
void std_stdconcurrentcreate_pool(struct std_stdconcurrentThreadPool* __chx_struct_ret_param_xx, unsigned int n){
	...
	({ struct std_stdconcurrentPoolData* __chx__lv__45 = p; *__chx__lv__45 = (struct std_stdconcurrentPoolData){ 
		.m = (*({ struct std_stdmutex __chx__lv__46; std_stdmutexconstructor(&__chx__lv__46); &__chx__lv__46; })), 
		.cv = (*({ struct std_stdCondVar __chx__lv__47; std_stdCondVarconstructor(&__chx__lv__47); &__chx__lv__47; })), 
		.q = (*({ struct std_stdvector__cgs__0 __chx__lv__48; std_stdvector__cgs__0make(&__chx__lv__48); &__chx__lv__48; })), 
		.workers = (*({ struct std_stdvector__cgs__2 __chx__lv__49; std_stdvector__cgs__2make(&__chx__lv__49); &__chx__lv__49; })), 
		.run = 1
	}; __chx__lv__45; });
	unsigned int i = 0;
	while((i < n)) {
...
void std_stdstring_viewsubview(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t start, size_t end){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__50; std_stdstring_viewconstructor(&__chx__lv__50, (self->_data + start), (end - start)); &__chx__lv__50; }));
	return;
}
void std_stdstring_viewskip(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t count){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__51; std_stdstring_viewconstructor(&__chx__lv__51, (self->_data + count), (self->_size - count)); &__chx__lv__51; }));
	return;
}
size_t std_stdstring_viewfind(struct std_stdstring_view*const self, struct std_stdstring_view*const needle){
...
void std_stdstring_viewtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((s == self->_size)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__52; std_stdstring_viewconstructor(&__chx__lv__52, "", 0); &__chx__lv__52; }));
		return;
	}
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__53; std_stdstring_viewsubview(&__chx__lv__53, self, s, (e + 1)); &__chx__lv__53; }));
	return;
}
void std_stdstring_viewto_i8(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__9 __chx__lv__54; std_stdstring_viewto_i64(&__chx__lv__54, self); &__chx__lv__54; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int8_t) ((*({ struct std_stdResult__cgs__9 __chx__lv__55; std_stdstring_viewto_i64(&__chx__lv__55, self); &__chx__lv__55; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__9 __chx__lv__56; std_stdstring_viewto_i64(&__chx__lv__56, self); &__chx__lv__56; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__9 __chx__lv__57; std_stdstring_viewto_i64(&__chx__lv__57, self); &__chx__lv__57; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int16_t) ((*({ struct std_stdResult__cgs__9 __chx__lv__58; std_stdstring_viewto_i64(&__chx__lv__58, self); &__chx__lv__58; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__9 __chx__lv__59; std_stdstring_viewto_i64(&__chx__lv__59, self); &__chx__lv__59; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i32(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__9 __chx__lv__60; std_stdstring_viewto_i64(&__chx__lv__60, self); &__chx__lv__60; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int32_t) ((*({ struct std_stdResult__cgs__9 __chx__lv__61; std_stdstring_viewto_i64(&__chx__lv__61, self); &__chx__lv__61; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__9 __chx__lv__62; std_stdstring_viewto_i64(&__chx__lv__62, self); &__chx__lv__62; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__63; std_stdstring_viewconstructor(&__chx__lv__63, "empty string", 12); &__chx__lv__63; }))
		};
		return;
	}
	if((self->_data[i] == '-')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__64; std_stdstring_viewconstructor(&__chx__lv__64, "invalid format", 14); &__chx__lv__64; }))
		};
		return;
	}
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__65; std_stdstring_viewconstructor(&__chx__lv__65, "trailing characters", 19); &__chx__lv__65; }))
		};
		return;
	}
...
void std_stdstring_viewto_u8(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__13 __chx__lv__66; std_stdstring_viewto_u64(&__chx__lv__66, self); &__chx__lv__66; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint8_t) ((*({ struct std_stdResult__cgs__13 __chx__lv__67; std_stdstring_viewto_u64(&__chx__lv__67, self); &__chx__lv__67; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__13 __chx__lv__68; std_stdstring_viewto_u64(&__chx__lv__68, self); &__chx__lv__68; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u16(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__13 __chx__lv__69; std_stdstring_viewto_u64(&__chx__lv__69, self); &__chx__lv__69; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint16_t) ((*({ struct std_stdResult__cgs__13 __chx__lv__70; std_stdstring_viewto_u64(&__chx__lv__70, self); &__chx__lv__70; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__13 __chx__lv__71; std_stdstring_viewto_u64(&__chx__lv__71, self); &__chx__lv__71; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__13 __chx__lv__72; std_stdstring_viewto_u64(&__chx__lv__72, self); &__chx__lv__72; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint32_t) ((*({ struct std_stdResult__cgs__13 __chx__lv__73; std_stdstring_viewto_u64(&__chx__lv__73, self); &__chx__lv__73; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__13 __chx__lv__74; std_stdstring_viewto_u64(&__chx__lv__74, self); &__chx__lv__74; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__75; std_stdstring_viewconstructor(&__chx__lv__75, "empty string", 12); &__chx__lv__75; }))
		};
		return;
	}
	if((self->_data[i] == '+')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__76; std_stdstring_viewconstructor(&__chx__lv__76, "invalid format", 14); &__chx__lv__76; }))
		};
		return;
	}
	while(((i < self->_size) && isdigit(self->_data[i]))) {
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__77; std_stdstring_viewconstructor(&__chx__lv__77, "trailing characters", 19); &__chx__lv__77; }))
		};
		return;
	}
...
void std_stdstring_viewto_int(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__8 __chx__lv__78; std_stdstring_viewto_i32(&__chx__lv__78, self); &__chx__lv__78; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int) ((*({ struct std_stdResult__cgs__8 __chx__lv__79; std_stdstring_viewto_i32(&__chx__lv__79, self); &__chx__lv__79; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__8 __chx__lv__80; std_stdstring_viewto_i32(&__chx__lv__80, self); &__chx__lv__80; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__12 __chx__lv__81; std_stdstring_viewto_u32(&__chx__lv__81, self); &__chx__lv__81; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 0, 
				.Ok.value = ((unsigned int) ((*({ struct std_stdResult__cgs__12 __chx__lv__82; std_stdstring_viewto_u32(&__chx__lv__82, self); &__chx__lv__82; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__12 __chx__lv__83; std_stdstring_viewto_u32(&__chx__lv__83, self); &__chx__lv__83; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_float(struct std_stdResult__cgs__17* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__84; std_stdstring_viewconstructor(&__chx__lv__84, "empty string", 12); &__chx__lv__84; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__85; std_stdstring_viewconstructor(&__chx__lv__85, "invalid format", 14); &__chx__lv__85; }))
			};
			return;
		}
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__86; std_stdstring_viewconstructor(&__chx__lv__86, "trailing characters", 19); &__chx__lv__86; }))
			};
			return;
		}
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__87; std_stdstringview_make(&__chx__lv__87, self); &__chx__lv__87; }));
	_Bool __chx__lv__88 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__17 __chx__lv__89; std_stdstringto_float(&__chx__lv__89, &s); &__chx__lv__89; }));
	if(__chx__lv__88) {
...
void std_stdstring_viewto_double(struct std_stdResult__cgs__18* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__93; std_stdstringview_make(&__chx__lv__93, self); &__chx__lv__93; }));
	_Bool __chx__lv__94 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__18 __chx__lv__95; std_stdstringto_double(&__chx__lv__95, &s); &__chx__lv__95; }));
	if(__chx__lv__94) {
		std_stdstringdelete(&s);
	}
	return;
...
void std_stdstring_viewsplit(struct std_stdvector__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, char delim){
	struct std_stdvector__cgs__1 res = (*({ struct std_stdvector__cgs__1 __chx__lv__96; std_stdvector__cgs__1make(&__chx__lv__96); &__chx__lv__96; }));
	_Bool __chx__lv__97 = true;
	unsigned int start = 0;
	for(unsigned int i = 0;(i < self->_size);i++){
		if((std_stdstring_viewget(self, i) == delim)){
			std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__98; std_stdstring_viewsubview(&__chx__lv__98, self, start, i); &__chx__lv__98; })));
			start = (i + 1);
		}
	}
	if((start <= self->_size)){
		std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__99; std_stdstring_viewsubview(&__chx__lv__99, self, start, self->_size); &__chx__lv__99; })));
	}
	*__chx_struct_ret_param_xx = res;
	return;
}
void std_stdstring_viewto_string(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__100; std_stdstringview_make(&__chx__lv__100, self); &__chx__lv__100; }));
	return;
}
void std_stdstring_viewstream(struct std_stdstring_view*const self, struct std_stdStringStream* s){
...
void std_stdget_env(struct std_stdOption__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const name){
	...
	*__chx_struct_ret_param_xx = (struct std_stdOption__cgs__0) { .__chx__vt_621827 = 0, 
		.Some.value = (*({ struct std_stdstring __chx__lv__101; std_stdstringmake_no_len(&__chx__lv__101, ptr); &__chx__lv__101; }))
	};
	return;
}
...
void std_stdchronoDurationmul_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__102; std_stdchronoDurationfrom_nanos(&__chx__lv__102, result_nanos); &__chx__lv__102; }));
	return;
}
void std_stdchronoDurationdiv_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	if((scalar == 0)){
	...
	int64_t total_nanos = std_stdchronoDurationas_nanos(self);
	int64_t result_nanos = (total_nanos / scalar);
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__103; std_stdchronoDurationfrom_nanos(&__chx__lv__103, result_nanos); &__chx__lv__103; }));
	return;
}
void std_stdchronoDurationabs(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self){
	if((self->secs < 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__104; std_stdchronoDurationneg(&__chx__lv__104, self); &__chx__lv__104; }));
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdchronoDuration){ 
		.secs = self->secs, 
...
void std_stdchronoInstantduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__105; std_stdchronoDurationfrom_parts(&__chx__lv__105, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__105; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoInstantelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self){
	struct std_stdchronoInstant now_inst = (*({ struct std_stdchronoInstant __chx__lv__106; std_stdchronoInstantnow(&__chx__lv__106); &__chx__lv__106; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__107; std_stdchronoInstantduration_since(&__chx__lv__107, &now_inst, self); &__chx__lv__107; }));
	return;
}
void std_stdchronoInstantduration_to(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const later){
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__108; std_stdchronoInstantduration_since(&__chx__lv__108, later, self); &__chx__lv__108; }));
	return;
}
void std_stdchronoInstantadd_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__109; std_stdchronoDurationfrom_parts(&__chx__lv__109, self->secs, self->nanos); &__chx__lv__109; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__110; std_stdchronoDurationadd(&__chx__lv__110, &d, dur); &__chx__lv__110; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoInstantsub_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__111; std_stdchronoDurationfrom_parts(&__chx__lv__111, self->secs, self->nanos); &__chx__lv__111; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__112; std_stdchronoDurationsub(&__chx__lv__112, &d, dur); &__chx__lv__112; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoSystemTimefrom_unix_epoch_nanos(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, int64_t secs, int64_t nanos){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__113; std_stdchronoDurationfrom_parts(&__chx__lv__113, secs, nanos); &__chx__lv__113; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
...
void std_stdchronoSystemTimeduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoSystemTime*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__114; std_stdchronoDurationfrom_parts(&__chx__lv__114, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__114; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoSystemTimeelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self){
	struct std_stdchronoSystemTime now_st = (*({ struct std_stdchronoSystemTime __chx__lv__115; std_stdchronoSystemTimenow(&__chx__lv__115); &__chx__lv__115; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__116; std_stdchronoSystemTimeduration_since(&__chx__lv__116, &now_st, self); &__chx__lv__116; }));
	return;
}
void std_stdchronoSystemTimeadd_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__117; std_stdchronoDurationfrom_parts(&__chx__lv__117, self->secs, self->nanos); &__chx__lv__117; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__118; std_stdchronoDurationadd(&__chx__lv__118, &d, dur); &__chx__lv__118; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&sum), 
		.nanos = std_stdchronoDurationsubsec_nanos(&sum)
	};
...
void std_stdchronoSystemTimesub_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__119; std_stdchronoDurationfrom_parts(&__chx__lv__119, self->secs, self->nanos); &__chx__lv__119; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__120; std_stdchronoDurationsub(&__chx__lv__120, &d, dur); &__chx__lv__120; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&diff), 
		.nanos = std_stdchronoDurationsubsec_nanos(&diff)
	};
...
void std_stdstringto_i8(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__3 __chx__lv__139; std_stdstring_viewto_i8(&__chx__lv__139, &(*({ struct std_stdstring_view __chx__lv__140; std_stdstringto_view(&__chx__lv__140, self); &__chx__lv__140; }))); &__chx__lv__139; }));
	return;
}
void std_stdstringto_i16(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__6 __chx__lv__141; std_stdstring_viewto_i16(&__chx__lv__141, &(*({ struct std_stdstring_view __chx__lv__142; std_stdstringto_view(&__chx__lv__142, self); &__chx__lv__142; }))); &__chx__lv__141; }));
	return;
}
void std_stdstringto_i32(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__8 __chx__lv__143; std_stdstring_viewto_i32(&__chx__lv__143, &(*({ struct std_stdstring_view __chx__lv__144; std_stdstringto_view(&__chx__lv__144, self); &__chx__lv__144; }))); &__chx__lv__143; }));
	return;
}
void std_stdstringto_i64(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__9 __chx__lv__145; std_stdstring_viewto_i64(&__chx__lv__145, &(*({ struct std_stdstring_view __chx__lv__146; std_stdstringto_view(&__chx__lv__146, self); &__chx__lv__146; }))); &__chx__lv__145; }));
	return;
}
void std_stdstringto_u8(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__10 __chx__lv__147; std_stdstring_viewto_u8(&__chx__lv__147, &(*({ struct std_stdstring_view __chx__lv__148; std_stdstringto_view(&__chx__lv__148, self); &__chx__lv__148; }))); &__chx__lv__147; }));
	return;
}
void std_stdstringto_u16(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__11 __chx__lv__149; std_stdstring_viewto_u16(&__chx__lv__149, &(*({ struct std_stdstring_view __chx__lv__150; std_stdstringto_view(&__chx__lv__150, self); &__chx__lv__150; }))); &__chx__lv__149; }));
	return;
}
void std_stdstringto_u32(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__12 __chx__lv__151; std_stdstring_viewto_u32(&__chx__lv__151, &(*({ struct std_stdstring_view __chx__lv__152; std_stdstringto_view(&__chx__lv__152, self); &__chx__lv__152; }))); &__chx__lv__151; }));
	return;
}
void std_stdstringto_u64(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__13 __chx__lv__153; std_stdstring_viewto_u64(&__chx__lv__153, &(*({ struct std_stdstring_view __chx__lv__154; std_stdstringto_view(&__chx__lv__154, self); &__chx__lv__154; }))); &__chx__lv__153; }));
	return;
}
void std_stdstringto_int(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__14 __chx__lv__155; std_stdstring_viewto_int(&__chx__lv__155, &(*({ struct std_stdstring_view __chx__lv__156; std_stdstringto_view(&__chx__lv__156, self); &__chx__lv__156; }))); &__chx__lv__155; }));
	return;
}
void std_stdstringto_uint(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__16 __chx__lv__157; std_stdstring_viewto_uint(&__chx__lv__157, &(*({ struct std_stdstring_view __chx__lv__158; std_stdstringto_view(&__chx__lv__158, self); &__chx__lv__158; }))); &__chx__lv__157; }));
	return;
}
void std_stdstringto_float(struct std_stdResult__cgs__17* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	char* end = NULL;
