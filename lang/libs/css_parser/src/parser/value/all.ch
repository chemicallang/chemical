...
func putAllCSSValueParsers(
    ...
    map.put(std::string_view("border-left"), CSSParser::parseBorder)
    ...
    map.put(std::string_view("content"), CSSParser::parseContent)
    map.put(std::string_view("box-shadow"), CSSParser::parseBoxShadow)
    map.put(std::string_view("text-shadow"), CSSParser::parseTextShadow)
    map.put(std::string_view("transition"), CSSParser::parseTransition)
    map.put(std::string_view("transform"), CSSParser::parseTransform)
    ...
    map.put(std::string_view("scroll-snap-align"), CSSParser::parseRawPropertyValue)
    ...
    map.put(std::string_view("background"), CSSParser::parseBackground)
    map.put(std::string_view("background-image"), CSSParser::parseBackgroundImage)
    ...
    map.put(std::string_view("background-blend-mode"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("text-decoration"), CSSParser::parseTextDecoration)
    ...
    map.put(std::string_view("text-decoration-color"), CSSParser::parseTextDecorationColor)
    map.put(std::string_view("text-decoration-thickness"), CSSParser::parseTextDecorationThickness)
    ...
    map.put(std::string_view("filter"), CSSParser::parseBackdropFilter)
    map.put(std::string_view("clip-path"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("columns"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("column-count"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("column-gap"), CSSParser::parseMarginSingle)
    map.put(std::string_view("column-rule"), CSSParser::parseBorder)
    map.put(std::string_view("transform-origin"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("perspective"), CSSParser::parseWidth)
    map.put(std::string_view("perspective-origin"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("border-image"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("letter-spacing"), CSSParser::parseMarginSingle)
    map.put(std::string_view("word-spacing"), CSSParser::parseMarginSingle)
    map.put(std::string_view("line-height"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("text-indent"), CSSParser::parseMarginSingle)
    map.put(std::string_view("counter-reset"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("counter-increment"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("list-style-image"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("outline-offset"), CSSParser::parseMarginSingle)
    map.put(std::string_view("scroll-snap-type"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("margin-inline"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-block"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("margin-block"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-inline"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("scrollbar-color"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("mask-image"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("text-emphasis"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("paint-order"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("view-transition-name"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("shape-outside"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("caret-color"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("font-feature-settings"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("font-variation-settings"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("voice-family"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("stroke-dasharray"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("stroke-linejoin"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("-webkit-line-clamp"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("-webkit-box-orient"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("-webkit-text-stroke"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("-moz-column-gap"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("-webkit-appearance"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("object-position"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("background-position"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("text-decoration-offset"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("text-underline-offset"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("speak"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("opacity"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("min-width"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("max-width"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("min-height"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("max-height"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("order"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("flex-basis"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("flex-flow"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("grid-auto-rows"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("grid-auto-columns"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("grid-gap"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("clip"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-top"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-left"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-right"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("padding-bottom"), CSSParser::parseRawPropertyValue)
    map.put(std::string_view("src"), CSSParser::parseRawPropertyValue)
}
