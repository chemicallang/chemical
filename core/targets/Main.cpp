...
//    SocketStream stream();
    ...
    handler.add<lsp::notifications::Initialized>([&manager](lsp::notifications::Initialized::Params&& params){
#ifdef DEBUG_LOG_REQS
        std::cout << "[lsp] lsp::notifications::Initialized" << std::endl;
#endif
        manager.register_watched_files_capability();
    });
