...
@6 = private unnamed_addr constant [19 x i8] c"for loop end : %d\0A\00", align 1
@7 = private unnamed_addr constant [14 x i8] c"check c : %d\0A\00", align 1
...
forend:                                           ; preds = %forcond
  ...
  store i32 10, ptr %j8, align 4
  %j9 = load i32, ptr %j8, align 4
  %19 = call i32 (ptr, ...) @printf(ptr @6, i32 %j9)
  %c = alloca i32, align 4
  store i32 155, ptr %c, align 4
  %c10 = load i32, ptr %c, align 4
  %20 = call i32 (ptr, ...) @printf(ptr @7, i32 %c10)
  ret i32 0
}
