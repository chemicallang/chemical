...
void std_stdResult__cgs__7delete(struct std_stdResult__cgs__7* self);
struct std_stdResult__cgs__8 {
	int __chx__vt_621827;
	union {
		struct {
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_u64(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_int(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdstringto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
void std_stdstringto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_u64(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_int(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
const struct std_stdstring_view* core_coreiterableLinear__cgs__1_vector__cgs__0_data(struct std_stdvector__cgs__0*const self){
	return self->data_ptr;
}
...
const __chx_core_coreiterableLinear__cgs__1_vt_t core_coreiterableLinear__cgs__1std_stdvector__cgs__0 = {
	(const struct std_stdstring_view*(*)(void* self)) core_coreiterableLinear__cgs__1_vector__cgs__0_data,
...
const struct std_stdconcurrentTask* core_coreiterableLinear__cgs__0_vector__cgs__1_data(struct std_stdvector__cgs__1*const self){
	return self->data_ptr;
}
...
const __chx_core_coreiterableLinear__cgs__0_vt_t core_coreiterableLinear__cgs__0std_stdvector__cgs__1 = {
	(const struct std_stdconcurrentTask*(*)(void* self)) core_coreiterableLinear__cgs__0_vector__cgs__1_data,
...
void std_stdstring_viewto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__9; std_stdstring_viewto_i64(&__chx__lv__9, self); &__chx__lv__9; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int8_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__10; std_stdstring_viewto_i64(&__chx__lv__10, self); &__chx__lv__10; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__11; std_stdstring_viewto_i64(&__chx__lv__11, self); &__chx__lv__11; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__12; std_stdstring_viewto_i64(&__chx__lv__12, self); &__chx__lv__12; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int16_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__13; std_stdstring_viewto_i64(&__chx__lv__13, self); &__chx__lv__13; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__14; std_stdstring_viewto_i64(&__chx__lv__14, self); &__chx__lv__14; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__15; std_stdstring_viewto_i64(&__chx__lv__15, self); &__chx__lv__15; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__5) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int32_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__16; std_stdstring_viewto_i64(&__chx__lv__16, self); &__chx__lv__16; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__5) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__17; std_stdstring_viewto_i64(&__chx__lv__17, self); &__chx__lv__17; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
	...
	*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 0, 
		.Ok.value = (res * sign)
	};
	return;
}
void std_stdstring_viewto_u8(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__21; std_stdstring_viewto_u64(&__chx__lv__21, self); &__chx__lv__21; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint8_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__22; std_stdstring_viewto_u64(&__chx__lv__22, self); &__chx__lv__22; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__23; std_stdstring_viewto_u64(&__chx__lv__23, self); &__chx__lv__23; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u16(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__24; std_stdstring_viewto_u64(&__chx__lv__24, self); &__chx__lv__24; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint16_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__25; std_stdstring_viewto_u64(&__chx__lv__25, self); &__chx__lv__25; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__26; std_stdstring_viewto_u64(&__chx__lv__26, self); &__chx__lv__26; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__27; std_stdstring_viewto_u64(&__chx__lv__27, self); &__chx__lv__27; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint32_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__28; std_stdstring_viewto_u64(&__chx__lv__28, self); &__chx__lv__28; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__29; std_stdstring_viewto_u64(&__chx__lv__29, self); &__chx__lv__29; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__10 __chx__lv__36; std_stdstring_viewto_u32(&__chx__lv__36, self); &__chx__lv__36; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 0, 
				.Ok.value = ((unsigned int) ((*({ struct std_stdResult__cgs__10 __chx__lv__37; std_stdstring_viewto_u32(&__chx__lv__37, self); &__chx__lv__37; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__10 __chx__lv__38; std_stdstring_viewto_u32(&__chx__lv__38, self); &__chx__lv__38; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__15 __chx__lv__44; std_stdstringto_float(&__chx__lv__44, &s); &__chx__lv__44; }));
	if(__chx__lv__43) {
...
void std_stdstring_viewto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__16 __chx__lv__50; std_stdstringto_double(&__chx__lv__50, &s); &__chx__lv__50; }));
	if(__chx__lv__49) {
		std_stdstringdelete(&s);
	}
	return;
...
void std_stdallocGlobalAllocatoralloc_zeroed(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout){
	struct std_stdResult__cgs__1 result = (*({ struct std_stdResult__cgs__1 __chx__lv__57; std_stdallocGlobalAllocatoralloc(&__chx__lv__57, self, ({ struct std_stdallocLayout __chx__lv__58 = *layout; &__chx__lv__58; })); &__chx__lv__57; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__1* __chx__lv__59 = &result;
	memset(__chx__lv__59->Ok.value, 0, layout->size);
	*__chx_struct_ret_param_xx = result;
	return;
}
void std_stdallocGlobalAllocatorcheck_leaks(struct std_stdallocGlobalAllocator*const self){
...
void std_stdallocalloc_zeroed_bytes(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, size_t size){
	struct std_stdResult__cgs__1 result = (*({ struct std_stdResult__cgs__1 __chx__lv__60; std_stdallocalloc_bytes(&__chx__lv__60, size); &__chx__lv__60; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__1* __chx__lv__61 = &result;
	memset(__chx__lv__61->Ok.value, 0, size);
	*__chx_struct_ret_param_xx = result;
	return;
}
...
void std_stdu16stringsubstr(struct std_stdu16string* __chx_struct_ret_param_xx, struct std_stdu16string*const self, size_t start, size_t len){
	struct std_stdu16string result = (*({ struct std_stdu16string __chx__lv__65; std_stdu16stringempty_str(&__chx__lv__65); &__chx__lv__65; }));
	...
	buf[real_len] = 0;
	struct std_stdu16string __chx__lv__67 = (*({ struct std_stdu16string __chx__lv__68; std_stdu16stringconstructor(&__chx__lv__68, buf, real_len); &__chx__lv__68; }));
	*__chx_struct_ret_param_xx = result;
	std_stdu16stringdelete(&__chx__lv__67);
	return;
}
void std_stdu16stringto_utf8(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdu16string*const self){
	size_t n = std_stdu16stringsize(self);
	if((n == 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__69; std_stdstringempty_str(&__chx__lv__69); &__chx__lv__69; }));
		return;
	}
	unsigned long out_cap = ((n * 3) + 1);
	struct std_stdstring out = (*({ struct std_stdstring __chx__lv__70; std_stdstringempty_str(&__chx__lv__70); &__chx__lv__70; }));
	_Bool __chx__lv__71 = true;
...
int std_stdu16stringfind(struct std_stdu16string*const self, struct std_stdu16string* sub){
	...
	if((m == 0)){
		const int __chx__lv__73 = 0;
		if(__chx__lv__72) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__73;
	}
	if((m > n)){
		const int __chx__lv__74 = -1;
		if(__chx__lv__72) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__74;
	}
	const uint16_t* src = std_stdu16stringdata(self);
	...
	while(((i + m) <= n)) {
		...
		if((j == m)){
			const int __chx__lv__75 = ((int) i);
			if(__chx__lv__72) {
				std_stdu16stringdelete(sub);
			}
			return __chx__lv__75;
		}
		i = (i + 1);
	}
	const int __chx__lv__76 = -1;
	if(__chx__lv__72) {
		std_stdu16stringdelete(sub);
	}
	return __chx__lv__76;
}
_Bool std_stdu16stringstarts_with(struct std_stdu16string*const self, struct std_stdu16string* prefix){
	...
	if((p_len > my_len)){
		const _Bool __chx__lv__78 = 0;
		if(__chx__lv__77) {
			std_stdu16stringdelete(prefix);
		}
		return __chx__lv__78;
	}
	const uint16_t* src = std_stdu16stringdata(self);
	...
	while((i < p_len)) {
		if((src[i] != pre[i])){
			const _Bool __chx__lv__79 = 0;
			if(__chx__lv__77) {
				std_stdu16stringdelete(prefix);
			}
			return __chx__lv__79;
		}
		i = (i + 1);
	}
	const _Bool __chx__lv__80 = 1;
	if(__chx__lv__77) {
		std_stdu16stringdelete(prefix);
	}
	return __chx__lv__80;
}
_Bool std_stdu16stringends_with(struct std_stdu16string*const self, struct std_stdu16string* suffix){
	...
	size_t my_len = std_stdu16stringsize(self);
	if((s_len > my_len)){
		const _Bool __chx__lv__82 = 0;
		if(__chx__lv__81) {
			std_stdu16stringdelete(suffix);
		}
		return __chx__lv__82;
	}
	const uint16_t* src = std_stdu16stringdata(self);
	...
	const _Bool __chx__lv__84 = 1;
	if(__chx__lv__81) {
		std_stdu16stringdelete(suffix);
	}
	return __chx__lv__84;
}
void std_stdu16stringpush_back(struct std_stdu16string* self, uint16_t u){
...
static void __chemda_367_0(void* this){
}
cstd_usize std_stdconcurrenthardware_threads(){
...
static const void* std_stdconcurrentworker_main(const void* arg){
	...
	while(1) {
		...
		if((std_stdvector__cgs__1size(&P->q) > 0)){
			...
			struct std_stdconcurrentTask t = (*({ struct std_stdconcurrentTask __chx__lv__85; std_stdreplace__cfg_0(&__chx__lv__85, &*first_ele, &(struct std_stdconcurrentTask){ 
				.f = *({ __chemical_fat_pointer__* __chemda_367_0_pair = &(__chemical_fat_pointer__){__chemda_367_0,NULL}; &(*({ struct std_stddefault_function_instance __chx__lv__86; std_stddefault_function_instancemake2(&__chx__lv__86, __chemda_367_0_pair->first, __chemda_367_0_pair->second, ((std_stddestructor_type) NULL), 0, 0); &__chx__lv__86; })); })
			}); &__chx__lv__85; }));
		...
		if((opt.__chx__vt_621827 == 0)){
			struct std_stdOption__cgs__1* __chx__lv__87 = &opt;
			({ struct std_stddefault_function_instance* __chx__lv__88 = &__chx__lv__87->Some.value.f; ((void(*)(void*))std_stddefault_function_instanceget_fn_ptr(__chx__lv__88))(std_stddefault_function_instanceget_data_ptr(__chx__lv__88)); });
		}
	}
	return NULL;
}
void std_stdconcurrentPoolDatasubmit_void(struct std_stdconcurrentPoolData* self, std_stdfunction* f){
	_Bool __chx__lv__89 = true;
	std_stdmutexlock(&self->m);
	std_stdvector__cgs__1push_back(&self->q, &(struct std_stdconcurrentTask){ 
		.f = ({ __chx__lv__89 = false; *f; })
	});
...
void std_stdconcurrentThreadPoolsubmit_void(struct std_stdconcurrentThreadPool*const self, std_stdfunction* f){
	...
	std_stdconcurrentPoolDatasubmit_void(self->data, ({ __chx__lv__90 = false; &*f; }));
	if(__chx__lv__90) {
		std_stddefault_function_instancedelete(f);
	}
}
void std_stdconcurrentThreadPooldelete(struct std_stdconcurrentThreadPool*const self){
	struct std_stdconcurrentPoolData*__chx__lv__91 = self->data;
	
	std_stdconcurrentPoolDatadelete(__chx__lv__91);
	free(__chx__lv__91);
	__chx__dstctr_clnup_blk__:{
	}
}
void std_stdconcurrentcreate_pool(struct std_stdconcurrentThreadPool* __chx_struct_ret_param_xx, unsigned int n){
	...
	({ struct std_stdconcurrentPoolData* __chx__lv__92 = p; *__chx__lv__92 = (struct std_stdconcurrentPoolData){ 
		.m = (*({ struct std_stdmutex __chx__lv__93; std_stdmutexconstructor(&__chx__lv__93); &__chx__lv__93; })), 
		.cv = (*({ struct std_stdCondVar __chx__lv__94; std_stdCondVarconstructor(&__chx__lv__94); &__chx__lv__94; })), 
		.q = (*({ struct std_stdvector__cgs__1 __chx__lv__95; std_stdvector__cgs__1make(&__chx__lv__95); &__chx__lv__95; })), 
		.workers = (*({ struct std_stdvector__cgs__2 __chx__lv__96; std_stdvector__cgs__2make(&__chx__lv__96); &__chx__lv__96; })), 
		.run = 1
	}; __chx__lv__92; });
	unsigned int i = 0;
	while((i < n)) {
...
void std_stdstringview_make2(struct std_stdstring* this, struct std_stdstring_view* value){
	*this = (*({ struct std_stdstring __chx__lv__99; std_stdstringview_make(&__chx__lv__99, value); &__chx__lv__99; }));
	return;
}
void std_stdstringconstructor2(struct std_stdstring* this, const char* value, size_t length, _Bool ensure){
	struct std_stdstring s = (struct std_stdstring){ 
...
void std_stdstringappend_double(struct std_stdstring* self, double value, int precision){
	...
	if(std_stddbl_is_nan(value)){
		std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__103; std_stdstring_viewconstructor(&__chx__lv__103, "nan", 3); &__chx__lv__103; })));
		return;
	}
	if(std_stddbl_is_inf(value)){
		if(std_stddbl_is_neg(value)){
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__104; std_stdstring_viewconstructor(&__chx__lv__104, "-inf", 4); &__chx__lv__104; })));
		} else {
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__105; std_stdstring_viewconstructor(&__chx__lv__105, "inf", 3); &__chx__lv__105; })));
		}
		return;
	}
	double v = value;
...
void std_stdstringcopy(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__106; std_stdstringsubstring(&__chx__lv__106, self, 0, std_stdstringsize(self)); &__chx__lv__106; }));
	return;
}
void std_stdstringsubstring(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self, size_t start, size_t end){
	struct std_stdstring s;
	_Bool __chx__lv__107 = true;
...
size_t std_stdstringfind(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__108; std_stdstring_viewconstructor(&__chx__lv__108, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__108; }));
	return std_stdinternal_view_find(&view, needle);
}
size_t std_stdstringfind_last(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__109; std_stdstring_viewconstructor(&__chx__lv__109, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__109; }));
...
void std_stdstringtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__110; std_stdstring_viewtrim(&__chx__lv__110, &(*({ struct std_stdstring_view __chx__lv__111; std_stdstringto_view(&__chx__lv__111, self); &__chx__lv__111; }))); &__chx__lv__110; }));
	return;
}
void std_stdstringsplit(struct std_stdvector__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring*const self, char delim){
	*__chx_struct_ret_param_xx = (*({ struct std_stdvector__cgs__0 __chx__lv__112; std_stdstring_viewsplit(&__chx__lv__112, &(*({ struct std_stdstring_view __chx__lv__113; std_stdstringto_view(&__chx__lv__113, self); &__chx__lv__113; })), delim); &__chx__lv__112; }));
	return;
}
_Bool std_stdstringends_with(struct std_stdstring*const self, struct std_stdstring_view*const other){
	if((std_stdstring_viewsize(other) > std_stdstringsize(self))){
...
void std_stdstringto_view(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__114; std_stdstring_viewconstructor(&__chx__lv__114, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__114; }));
	return;
}
void std_stdstringto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__0 __chx__lv__115; std_stdstring_viewto_i8(&__chx__lv__115, &(*({ struct std_stdstring_view __chx__lv__116; std_stdstringto_view(&__chx__lv__116, self); &__chx__lv__116; }))); &__chx__lv__115; }));
	return;
}
void std_stdstringto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__3 __chx__lv__117; std_stdstring_viewto_i16(&__chx__lv__117, &(*({ struct std_stdstring_view __chx__lv__118; std_stdstringto_view(&__chx__lv__118, self); &__chx__lv__118; }))); &__chx__lv__117; }));
	return;
}
void std_stdstringto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__5 __chx__lv__119; std_stdstring_viewto_i32(&__chx__lv__119, &(*({ struct std_stdstring_view __chx__lv__120; std_stdstringto_view(&__chx__lv__120, self); &__chx__lv__120; }))); &__chx__lv__119; }));
	return;
}
void std_stdstringto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__6 __chx__lv__121; std_stdstring_viewto_i64(&__chx__lv__121, &(*({ struct std_stdstring_view __chx__lv__122; std_stdstringto_view(&__chx__lv__122, self); &__chx__lv__122; }))); &__chx__lv__121; }));
	return;
}
void std_stdstringto_u8(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__8 __chx__lv__123; std_stdstring_viewto_u8(&__chx__lv__123, &(*({ struct std_stdstring_view __chx__lv__124; std_stdstringto_view(&__chx__lv__124, self); &__chx__lv__124; }))); &__chx__lv__123; }));
	return;
}
void std_stdstringto_u16(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__9 __chx__lv__125; std_stdstring_viewto_u16(&__chx__lv__125, &(*({ struct std_stdstring_view __chx__lv__126; std_stdstringto_view(&__chx__lv__126, self); &__chx__lv__126; }))); &__chx__lv__125; }));
	return;
}
void std_stdstringto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__10 __chx__lv__127; std_stdstring_viewto_u32(&__chx__lv__127, &(*({ struct std_stdstring_view __chx__lv__128; std_stdstringto_view(&__chx__lv__128, self); &__chx__lv__128; }))); &__chx__lv__127; }));
	return;
}
void std_stdstringto_u64(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__11 __chx__lv__129; std_stdstring_viewto_u64(&__chx__lv__129, &(*({ struct std_stdstring_view __chx__lv__130; std_stdstringto_view(&__chx__lv__130, self); &__chx__lv__130; }))); &__chx__lv__129; }));
	return;
}
void std_stdstringto_int(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__13 __chx__lv__131; std_stdstring_viewto_int(&__chx__lv__131, &(*({ struct std_stdstring_view __chx__lv__132; std_stdstringto_view(&__chx__lv__132, self); &__chx__lv__132; }))); &__chx__lv__131; }));
	return;
}
void std_stdstringto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__14 __chx__lv__133; std_stdstring_viewto_uint(&__chx__lv__133, &(*({ struct std_stdstring_view __chx__lv__134; std_stdstringto_view(&__chx__lv__134, self); &__chx__lv__134; }))); &__chx__lv__133; }));
	return;
}
void std_stdstringto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	char* end = NULL;
...
void std_stdstringto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__137; std_stdstring_viewconstructor(&__chx__lv__137, "invalid format", 14); &__chx__lv__137; }))
		};
		return;
	}
	while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__138; std_stdstring_viewconstructor(&__chx__lv__138, "trailing characters", 19); &__chx__lv__138; }))
		};
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 0, 
...
void std_stdchronoDurationmul_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__139; std_stdchronoDurationfrom_nanos(&__chx__lv__139, result_nanos); &__chx__lv__139; }));
	return;
}
void std_stdchronoDurationdiv_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	if((scalar == 0)){
	...
	int64_t total_nanos = std_stdchronoDurationas_nanos(self);
	int64_t result_nanos = (total_nanos / scalar);
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__140; std_stdchronoDurationfrom_nanos(&__chx__lv__140, result_nanos); &__chx__lv__140; }));
	return;
}
void std_stdchronoDurationabs(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self){
	if((self->secs < 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__141; std_stdchronoDurationneg(&__chx__lv__141, self); &__chx__lv__141; }));
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdchronoDuration){ 
		.secs = self->secs, 
...
void std_stdchronoInstantduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__142; std_stdchronoDurationfrom_parts(&__chx__lv__142, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__142; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoInstantelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self){
	struct std_stdchronoInstant now_inst = (*({ struct std_stdchronoInstant __chx__lv__143; std_stdchronoInstantnow(&__chx__lv__143); &__chx__lv__143; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__144; std_stdchronoInstantduration_since(&__chx__lv__144, &now_inst, self); &__chx__lv__144; }));
	return;
}
void std_stdchronoInstantduration_to(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const later){
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__145; std_stdchronoInstantduration_since(&__chx__lv__145, later, self); &__chx__lv__145; }));
	return;
}
void std_stdchronoInstantadd_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__146; std_stdchronoDurationfrom_parts(&__chx__lv__146, self->secs, self->nanos); &__chx__lv__146; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__147; std_stdchronoDurationadd(&__chx__lv__147, &d, dur); &__chx__lv__147; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoInstantsub_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__148; std_stdchronoDurationfrom_parts(&__chx__lv__148, self->secs, self->nanos); &__chx__lv__148; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__149; std_stdchronoDurationsub(&__chx__lv__149, &d, dur); &__chx__lv__149; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoSystemTimefrom_unix_epoch_nanos(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, int64_t secs, int64_t nanos){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__150; std_stdchronoDurationfrom_parts(&__chx__lv__150, secs, nanos); &__chx__lv__150; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
...
void std_stdchronoSystemTimeduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoSystemTime*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__151; std_stdchronoDurationfrom_parts(&__chx__lv__151, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__151; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoSystemTimeelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self){
	struct std_stdchronoSystemTime now_st = (*({ struct std_stdchronoSystemTime __chx__lv__152; std_stdchronoSystemTimenow(&__chx__lv__152); &__chx__lv__152; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__153; std_stdchronoSystemTimeduration_since(&__chx__lv__153, &now_st, self); &__chx__lv__153; }));
	return;
}
void std_stdchronoSystemTimeadd_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__154; std_stdchronoDurationfrom_parts(&__chx__lv__154, self->secs, self->nanos); &__chx__lv__154; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__155; std_stdchronoDurationadd(&__chx__lv__155, &d, dur); &__chx__lv__155; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&sum), 
		.nanos = std_stdchronoDurationsubsec_nanos(&sum)
	};
...
void std_stdchronoSystemTimesub_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__156; std_stdchronoDurationfrom_parts(&__chx__lv__156, self->secs, self->nanos); &__chx__lv__156; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__157; std_stdchronoDurationsub(&__chx__lv__157, &d, dur); &__chx__lv__157; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&diff), 
		.nanos = std_stdchronoDurationsubsec_nanos(&diff)
	};
...
static void std_stdOsStringmake(struct std_stdOsString* this, std_stdnative_string_t* str){
	_Bool __chx__lv__158 = true;
	*this = (struct std_stdOsString){ 
		.data_ = ({ __chx__lv__158 = false; *str; })
	};
	if(__chx__lv__158) {
...
static void std_stdOsStringmake2(struct std_stdOsString* this, struct std_stdstring*const utf8){
	...
	*this = (struct std_stdOsString){ 
		.data_ = (*({ struct std_stdstring __chx__lv__159; std_stdstringcopy(&__chx__lv__159, utf8); &__chx__lv__159; }))
	};
	return;
}
static void std_stdOsStringfrom_utf8(struct std_stdOsString* __chx_struct_ret_param_xx, struct std_stdstring*const utf8){
	*__chx_struct_ret_param_xx = (*({ struct std_stdOsString __chx__lv__160; std_stdOsStringmake2(&__chx__lv__160, utf8); &__chx__lv__160; }));
	return;
}
static size_t std_stdOsStringsize(struct std_stdOsString*const self){
...
void std_stdget_env(struct std_stdOption__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const name){
	...
	*__chx_struct_ret_param_xx = (struct std_stdOption__cgs__0) { .__chx__vt_621827 = 0, 
		.Some.value = (*({ struct std_stdstring __chx__lv__161; std_stdstringmake_no_len(&__chx__lv__161, ptr); &__chx__lv__161; }))
	};
	return;
}
