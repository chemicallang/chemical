...
@2 = private unnamed_addr constant [14 x i8] c"current : %d\0A\00", align 1
...
entry:
  ...
  %4 = getelementptr [5 x i32], ptr %arr, i32 0, i32 0
  store i32 2, ptr %4, align 4
  %5 = getelementptr [5 x i32], ptr %arr, i32 0, i32 1
  store i32 4, ptr %5, align 4
  %6 = getelementptr [5 x i32], ptr %arr, i32 0, i32 2
  store i32 6, ptr %6, align 4
  %7 = getelementptr [5 x i32], ptr %arr, i32 0, i32 3
  store i32 8, ptr %7, align 4
  %8 = getelementptr [5 x i32], ptr %arr, i32 0, i32 4
...
loopcond:                                         ; preds = %ifend, %entry
  ...
  %9 = icmp slt i32 %i1, 5
  br i1 %9, label %loopthen, label %loopexit
...
ifend:                                            ; preds = %loopthen
  ...
  %11 = getelementptr [5 x i32], ptr %arr, i32 0, i32 %i3
  %arr0 = load i32, ptr %11, align 4
  %12 = call i32 (ptr, ...) @printf(ptr @2, i32 %arr0)
