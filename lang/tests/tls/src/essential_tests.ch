...
public func tls_aes128_ecb_encrypt_decrypt_roundtrip(env : &mut TestEnv) {
    var key : [16]u8 = [0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6, 0xAB, 0xF7, 0x15, 0x88, 0x09, 0xCF, 0x4F, 0x3C]
    var plaintext : [16]u8 = [0x6B, 0xC1, 0xBE, 0xE2, 0x2E, 0x40, 0x9F, 0x96, 0xE9, 0x3D, 0x7E, 0x11, 0x73, 0x93, 0x17, 0x2A]
    unsafe var ciphertext : [16]u8
    unsafe var decrypted : [16]u8
    unsafe var enc_ctx : tls::AESContext
    ...
    unsafe var dec_ctx : tls::AESContext
...
public func tls_aes128_gcm_encrypt_decrypt_roundtrip(env : &mut TestEnv) {
    ...
    unsafe var gcm_ctx : tls::GCMContext
    ...
    unsafe var decrypted : [16]u8
    unsafe var gcm_ctx2 : tls::GCMContext
...
public func tls_prf_known_answer_master_secret(env : &mut TestEnv) {
    ...
    unsafe var client_random : [32]u8 = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
    unsafe var server_random : [32]u8 = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
...
public func tls_ecdh_shared_secret_deterministic(env : &mut TestEnv) {
    ...
    unsafe var shared1 : [32]u8
    unsafe var shared2 : [32]u8
...
public func tls_ecdh_keypair_uses_csprng(env : &mut TestEnv) {
    ...
    unsafe var ctx1 : tls::ECDHContext
    tls::ecdh_init(&raw mut ctx1)
    unsafe var priv1 : [32]u8
    unsafe var pub1 : [65]u8
    ...
    unsafe var ctx2 : tls::ECDHContext
    tls::ecdh_init(&raw mut ctx2)
    unsafe var priv2 : [32]u8
    unsafe var pub2 : [65]u8
