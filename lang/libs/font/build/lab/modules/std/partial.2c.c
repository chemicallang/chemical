...
void std_stdResult__cgs__8delete(struct std_stdResult__cgs__8* self);
...
void std_stdstringto_uint(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_float(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_double(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_float(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_double(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
static void __chemda_230_0(void* this){
}
cstd_usize std_stdconcurrenthardware_threads(){
...
static const void* std_stdconcurrentworker_main(const void* arg){
	...
	while(1) {
		...
		if((std_stdvector__cgs__0size(&P->q) > 0)){
			...
			struct std_stdconcurrentTask t = (*({ struct std_stdconcurrentTask __chx__lv__8; std_stdreplace__cfg_0(&__chx__lv__8, &*first_ele, &(struct std_stdconcurrentTask){ 
				.f = *({ __chemical_fat_pointer__* __chemda_230_0_pair = &(__chemical_fat_pointer__){__chemda_230_0,NULL}; &(*({ struct std_stddefault_function_instance __chx__lv__9; std_stddefault_function_instancemake2(&__chx__lv__9, __chemda_230_0_pair->first, __chemda_230_0_pair->second, ((std_stddestructor_type) NULL), 0, 0); &__chx__lv__9; })); })
			}); &__chx__lv__8; }));
		...
		if((opt.__chx__vt_621827 == 0)){
			struct std_stdOption__cgs__1* __chx__lv__10 = &opt;
			({ struct std_stddefault_function_instance* __chx__lv__11 = &__chx__lv__10->Some.value.f; ((void(*)(void*))std_stddefault_function_instanceget_fn_ptr(__chx__lv__11))(std_stddefault_function_instanceget_data_ptr(__chx__lv__11)); });
		}
	}
	return NULL;
}
...
void std_stdconcurrentThreadPoolsubmit_void(struct std_stdconcurrentThreadPool*const self, std_stdfunction* f){
	...
	std_stdconcurrentPoolDatasubmit_void(self->data, ({ __chx__lv__13 = false; &*f; }));
	if(__chx__lv__13) {
		std_stddefault_function_instancedelete(f);
	}
}
void std_stdconcurrentThreadPooldelete(struct std_stdconcurrentThreadPool*const self){
	struct std_stdconcurrentPoolData*__chx__lv__14 = self->data;
	
	std_stdconcurrentPoolDatadelete(__chx__lv__14);
	free(__chx__lv__14);
	__chx__dstctr_clnup_blk__:{
	}
}
void std_stdconcurrentcreate_pool(struct std_stdconcurrentThreadPool* __chx_struct_ret_param_xx, unsigned int n){
	...
	({ struct std_stdconcurrentPoolData* __chx__lv__15 = p; *__chx__lv__15 = (struct std_stdconcurrentPoolData){ 
		.m = (*({ struct std_stdmutex __chx__lv__16; std_stdmutexconstructor(&__chx__lv__16); &__chx__lv__16; })), 
		.cv = (*({ struct std_stdCondVar __chx__lv__17; std_stdCondVarconstructor(&__chx__lv__17); &__chx__lv__17; })), 
		.q = (*({ struct std_stdvector__cgs__0 __chx__lv__18; std_stdvector__cgs__0make(&__chx__lv__18); &__chx__lv__18; })), 
		.workers = (*({ struct std_stdvector__cgs__2 __chx__lv__19; std_stdvector__cgs__2make(&__chx__lv__19); &__chx__lv__19; })), 
		.run = 1
	}; __chx__lv__15; });
	unsigned int i = 0;
	while((i < n)) {
...
void std_stdchronoDurationmul_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__21; std_stdchronoDurationfrom_nanos(&__chx__lv__21, result_nanos); &__chx__lv__21; }));
	return;
}
void std_stdchronoDurationdiv_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	if((scalar == 0)){
	...
	int64_t total_nanos = std_stdchronoDurationas_nanos(self);
	int64_t result_nanos = (total_nanos / scalar);
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__22; std_stdchronoDurationfrom_nanos(&__chx__lv__22, result_nanos); &__chx__lv__22; }));
	return;
}
void std_stdchronoDurationabs(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self){
	if((self->secs < 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__23; std_stdchronoDurationneg(&__chx__lv__23, self); &__chx__lv__23; }));
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdchronoDuration){ 
		.secs = self->secs, 
...
void std_stdchronoInstantduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__24; std_stdchronoDurationfrom_parts(&__chx__lv__24, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__24; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoInstantelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self){
	struct std_stdchronoInstant now_inst = (*({ struct std_stdchronoInstant __chx__lv__25; std_stdchronoInstantnow(&__chx__lv__25); &__chx__lv__25; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__26; std_stdchronoInstantduration_since(&__chx__lv__26, &now_inst, self); &__chx__lv__26; }));
	return;
}
void std_stdchronoInstantduration_to(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const later){
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__27; std_stdchronoInstantduration_since(&__chx__lv__27, later, self); &__chx__lv__27; }));
	return;
}
void std_stdchronoInstantadd_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__28; std_stdchronoDurationfrom_parts(&__chx__lv__28, self->secs, self->nanos); &__chx__lv__28; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__29; std_stdchronoDurationadd(&__chx__lv__29, &d, dur); &__chx__lv__29; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoInstantsub_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__30; std_stdchronoDurationfrom_parts(&__chx__lv__30, self->secs, self->nanos); &__chx__lv__30; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__31; std_stdchronoDurationsub(&__chx__lv__31, &d, dur); &__chx__lv__31; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoSystemTimefrom_unix_epoch_nanos(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, int64_t secs, int64_t nanos){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__32; std_stdchronoDurationfrom_parts(&__chx__lv__32, secs, nanos); &__chx__lv__32; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
...
void std_stdchronoSystemTimeduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoSystemTime*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__33; std_stdchronoDurationfrom_parts(&__chx__lv__33, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__33; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoSystemTimeelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self){
	struct std_stdchronoSystemTime now_st = (*({ struct std_stdchronoSystemTime __chx__lv__34; std_stdchronoSystemTimenow(&__chx__lv__34); &__chx__lv__34; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__35; std_stdchronoSystemTimeduration_since(&__chx__lv__35, &now_st, self); &__chx__lv__35; }));
	return;
}
void std_stdchronoSystemTimeadd_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__36; std_stdchronoDurationfrom_parts(&__chx__lv__36, self->secs, self->nanos); &__chx__lv__36; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__37; std_stdchronoDurationadd(&__chx__lv__37, &d, dur); &__chx__lv__37; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&sum), 
		.nanos = std_stdchronoDurationsubsec_nanos(&sum)
	};
...
void std_stdchronoSystemTimesub_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__38; std_stdchronoDurationfrom_parts(&__chx__lv__38, self->secs, self->nanos); &__chx__lv__38; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__39; std_stdchronoDurationsub(&__chx__lv__39, &d, dur); &__chx__lv__39; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&diff), 
		.nanos = std_stdchronoDurationsubsec_nanos(&diff)
	};
...
void std_stdu16stringsubstr(struct std_stdu16string* __chx_struct_ret_param_xx, struct std_stdu16string*const self, size_t start, size_t len){
	struct std_stdu16string result = (*({ struct std_stdu16string __chx__lv__43; std_stdu16stringempty_str(&__chx__lv__43); &__chx__lv__43; }));
	...
	buf[real_len] = 0;
	struct std_stdu16string __chx__lv__45 = (*({ struct std_stdu16string __chx__lv__46; std_stdu16stringconstructor(&__chx__lv__46, buf, real_len); &__chx__lv__46; }));
	*__chx_struct_ret_param_xx = result;
	std_stdu16stringdelete(&__chx__lv__45);
	return;
}
void std_stdu16stringto_utf8(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdu16string*const self){
	size_t n = std_stdu16stringsize(self);
	if((n == 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__47; std_stdstringempty_str(&__chx__lv__47); &__chx__lv__47; }));
		return;
	}
	unsigned long out_cap = ((n * 3) + 1);
	struct std_stdstring out = (*({ struct std_stdstring __chx__lv__48; std_stdstringempty_str(&__chx__lv__48); &__chx__lv__48; }));
...
int std_stdu16stringfind(struct std_stdu16string*const self, struct std_stdu16string* sub){
	...
	if((m == 0)){
		const int __chx__lv__51 = 0;
		if(__chx__lv__50) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__51;
	}
	if((m > n)){
		const int __chx__lv__52 = -1;
		if(__chx__lv__50) {
			std_stdu16stringdelete(sub);
		}
...
void std_stdget_env(struct std_stdOption__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const name){
	...
	*__chx_struct_ret_param_xx = (struct std_stdOption__cgs__0) { .__chx__vt_621827 = 0, 
		.Some.value = (*({ struct std_stdstring __chx__lv__63; std_stdstringmake_no_len(&__chx__lv__63, ptr); &__chx__lv__63; }))
	};
	return;
}
...
void std_stdstringview_make2(struct std_stdstring* this, struct std_stdstring_view* value){
	*this = (*({ struct std_stdstring __chx__lv__66; std_stdstringview_make(&__chx__lv__66, value); &__chx__lv__66; }));
	return;
}
void std_stdstringconstructor2(struct std_stdstring* this, const char* value, size_t length, _Bool ensure){
	struct std_stdstring s = (struct std_stdstring){ 
...
void std_stdstringappend_double(struct std_stdstring* self, double value, int precision){
	...
	if(std_stddbl_is_nan(value)){
		std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__70; std_stdstring_viewconstructor(&__chx__lv__70, "nan", 3); &__chx__lv__70; })));
		return;
	}
	if(std_stddbl_is_inf(value)){
		if(std_stddbl_is_neg(value)){
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__71; std_stdstring_viewconstructor(&__chx__lv__71, "-inf", 4); &__chx__lv__71; })));
		} else {
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__72; std_stdstring_viewconstructor(&__chx__lv__72, "inf", 3); &__chx__lv__72; })));
		}
		return;
	}
	double v = value;
...
void std_stdstringcopy(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__73; std_stdstringsubstring(&__chx__lv__73, self, 0, std_stdstringsize(self)); &__chx__lv__73; }));
	return;
}
void std_stdstringsubstring(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self, size_t start, size_t end){
...
size_t std_stdstringfind(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__75; std_stdstring_viewconstructor(&__chx__lv__75, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__75; }));
	return std_stdinternal_view_find(&view, needle);
}
size_t std_stdstringfind_last(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__76; std_stdstring_viewconstructor(&__chx__lv__76, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__76; }));
...
void std_stdstringtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__77; std_stdstring_viewtrim(&__chx__lv__77, &(*({ struct std_stdstring_view __chx__lv__78; std_stdstringto_view(&__chx__lv__78, self); &__chx__lv__78; }))); &__chx__lv__77; }));
	return;
}
void std_stdstringsplit(struct std_stdvector__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring*const self, char delim){
	*__chx_struct_ret_param_xx = (*({ struct std_stdvector__cgs__1 __chx__lv__79; std_stdstring_viewsplit(&__chx__lv__79, &(*({ struct std_stdstring_view __chx__lv__80; std_stdstringto_view(&__chx__lv__80, self); &__chx__lv__80; })), delim); &__chx__lv__79; }));
	return;
}
_Bool std_stdstringends_with(struct std_stdstring*const self, struct std_stdstring_view*const other){
	if((std_stdstring_viewsize(other) > std_stdstringsize(self))){
...
void std_stdstringto_view(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__81; std_stdstring_viewconstructor(&__chx__lv__81, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__81; }));
	return;
}
void std_stdstringto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__0 __chx__lv__82; std_stdstring_viewto_i8(&__chx__lv__82, &(*({ struct std_stdstring_view __chx__lv__83; std_stdstringto_view(&__chx__lv__83, self); &__chx__lv__83; }))); &__chx__lv__82; }));
	return;
}
void std_stdstringto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__3 __chx__lv__84; std_stdstring_viewto_i16(&__chx__lv__84, &(*({ struct std_stdstring_view __chx__lv__85; std_stdstringto_view(&__chx__lv__85, self); &__chx__lv__85; }))); &__chx__lv__84; }));
	return;
}
void std_stdstringto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__5 __chx__lv__86; std_stdstring_viewto_i32(&__chx__lv__86, &(*({ struct std_stdstring_view __chx__lv__87; std_stdstringto_view(&__chx__lv__87, self); &__chx__lv__87; }))); &__chx__lv__86; }));
	return;
}
void std_stdstringto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__6 __chx__lv__88; std_stdstring_viewto_i64(&__chx__lv__88, &(*({ struct std_stdstring_view __chx__lv__89; std_stdstringto_view(&__chx__lv__89, self); &__chx__lv__89; }))); &__chx__lv__88; }));
	return;
}
void std_stdstringto_u8(struct std_stdResult__cgs__7* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__7 __chx__lv__90; std_stdstring_viewto_u8(&__chx__lv__90, &(*({ struct std_stdstring_view __chx__lv__91; std_stdstringto_view(&__chx__lv__91, self); &__chx__lv__91; }))); &__chx__lv__90; }));
	return;
}
void std_stdstringto_u16(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__9 __chx__lv__92; std_stdstring_viewto_u16(&__chx__lv__92, &(*({ struct std_stdstring_view __chx__lv__93; std_stdstringto_view(&__chx__lv__93, self); &__chx__lv__93; }))); &__chx__lv__92; }));
	return;
}
void std_stdstringto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__10 __chx__lv__94; std_stdstring_viewto_u32(&__chx__lv__94, &(*({ struct std_stdstring_view __chx__lv__95; std_stdstringto_view(&__chx__lv__95, self); &__chx__lv__95; }))); &__chx__lv__94; }));
	return;
}
void std_stdstringto_u64(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__11 __chx__lv__96; std_stdstring_viewto_u64(&__chx__lv__96, &(*({ struct std_stdstring_view __chx__lv__97; std_stdstringto_view(&__chx__lv__97, self); &__chx__lv__97; }))); &__chx__lv__96; }));
	return;
}
void std_stdstringto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__12 __chx__lv__98; std_stdstring_viewto_int(&__chx__lv__98, &(*({ struct std_stdstring_view __chx__lv__99; std_stdstringto_view(&__chx__lv__99, self); &__chx__lv__99; }))); &__chx__lv__98; }));
	return;
}
void std_stdstringto_uint(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__13 __chx__lv__100; std_stdstring_viewto_uint(&__chx__lv__100, &(*({ struct std_stdstring_view __chx__lv__101; std_stdstringto_view(&__chx__lv__101, self); &__chx__lv__101; }))); &__chx__lv__100; }));
	return;
}
void std_stdstringto_float(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	char* end = NULL;
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__102; std_stdstring_viewconstructor(&__chx__lv__102, "invalid format", 14); &__chx__lv__102; }))
		};
		return;
	}
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__103; std_stdstring_viewconstructor(&__chx__lv__103, "trailing characters", 19); &__chx__lv__103; }))
		};
		return;
	}
...
void std_stdstring_viewsubview(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t start, size_t end){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__106; std_stdstring_viewconstructor(&__chx__lv__106, (self->_data + start), (end - start)); &__chx__lv__106; }));
	return;
}
void std_stdstring_viewskip(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t count){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__107; std_stdstring_viewconstructor(&__chx__lv__107, (self->_data + count), (self->_size - count)); &__chx__lv__107; }));
	return;
}
size_t std_stdstring_viewfind(struct std_stdstring_view*const self, struct std_stdstring_view*const needle){
...
void std_stdstring_viewtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((s == self->_size)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__108; std_stdstring_viewconstructor(&__chx__lv__108, "", 0); &__chx__lv__108; }));
		return;
	}
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__109; std_stdstring_viewsubview(&__chx__lv__109, self, s, (e + 1)); &__chx__lv__109; }));
	return;
}
void std_stdstring_viewto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__110; std_stdstring_viewto_i64(&__chx__lv__110, self); &__chx__lv__110; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int8_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__111; std_stdstring_viewto_i64(&__chx__lv__111, self); &__chx__lv__111; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__112; std_stdstring_viewto_i64(&__chx__lv__112, self); &__chx__lv__112; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__113; std_stdstring_viewto_i64(&__chx__lv__113, self); &__chx__lv__113; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int16_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__114; std_stdstring_viewto_i64(&__chx__lv__114, self); &__chx__lv__114; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__115; std_stdstring_viewto_i64(&__chx__lv__115, self); &__chx__lv__115; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__116; std_stdstring_viewto_i64(&__chx__lv__116, self); &__chx__lv__116; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__5) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int32_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__117; std_stdstring_viewto_i64(&__chx__lv__117, self); &__chx__lv__117; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__5) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__118; std_stdstring_viewto_i64(&__chx__lv__118, self); &__chx__lv__118; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__119; std_stdstring_viewconstructor(&__chx__lv__119, "empty string", 12); &__chx__lv__119; }))
		};
		return;
	}
	if((self->_data[i] == '-')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__120; std_stdstring_viewconstructor(&__chx__lv__120, "invalid format", 14); &__chx__lv__120; }))
		};
		return;
	}
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__121; std_stdstring_viewconstructor(&__chx__lv__121, "trailing characters", 19); &__chx__lv__121; }))
		};
		return;
	}
...
void std_stdstring_viewto_u8(struct std_stdResult__cgs__7* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__122; std_stdstring_viewto_u64(&__chx__lv__122, self); &__chx__lv__122; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__7) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint8_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__123; std_stdstring_viewto_u64(&__chx__lv__123, self); &__chx__lv__123; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__7) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__124; std_stdstring_viewto_u64(&__chx__lv__124, self); &__chx__lv__124; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u16(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__125; std_stdstring_viewto_u64(&__chx__lv__125, self); &__chx__lv__125; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint16_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__126; std_stdstring_viewto_u64(&__chx__lv__126, self); &__chx__lv__126; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__127; std_stdstring_viewto_u64(&__chx__lv__127, self); &__chx__lv__127; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__128; std_stdstring_viewto_u64(&__chx__lv__128, self); &__chx__lv__128; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint32_t) ((*({ struct std_stdResult__cgs__11 __chx__lv__129; std_stdstring_viewto_u64(&__chx__lv__129, self); &__chx__lv__129; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__130; std_stdstring_viewto_u64(&__chx__lv__130, self); &__chx__lv__130; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__131; std_stdstring_viewconstructor(&__chx__lv__131, "empty string", 12); &__chx__lv__131; }))
		};
		return;
	}
	if((self->_data[i] == '+')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__132; std_stdstring_viewconstructor(&__chx__lv__132, "invalid format", 14); &__chx__lv__132; }))
		};
		return;
	}
	while(((i < self->_size) && isdigit(self->_data[i]))) {
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__133; std_stdstring_viewconstructor(&__chx__lv__133, "trailing characters", 19); &__chx__lv__133; }))
		};
		return;
	}
...
void std_stdstring_viewto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__5 __chx__lv__134; std_stdstring_viewto_i32(&__chx__lv__134, self); &__chx__lv__134; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int) ((*({ struct std_stdResult__cgs__5 __chx__lv__135; std_stdstring_viewto_i32(&__chx__lv__135, self); &__chx__lv__135; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__5 __chx__lv__136; std_stdstring_viewto_i32(&__chx__lv__136, self); &__chx__lv__136; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__10 __chx__lv__137; std_stdstring_viewto_u32(&__chx__lv__137, self); &__chx__lv__137; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 0, 
				.Ok.value = ((unsigned int) ((*({ struct std_stdResult__cgs__10 __chx__lv__138; std_stdstring_viewto_u32(&__chx__lv__138, self); &__chx__lv__138; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__10 __chx__lv__139; std_stdstring_viewto_u32(&__chx__lv__139, self); &__chx__lv__139; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_float(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__140; std_stdstring_viewconstructor(&__chx__lv__140, "empty string", 12); &__chx__lv__140; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__141; std_stdstring_viewconstructor(&__chx__lv__141, "invalid format", 14); &__chx__lv__141; }))
			};
			return;
		}
		while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__142; std_stdstring_viewconstructor(&__chx__lv__142, "trailing characters", 19); &__chx__lv__142; }))
			};
			return;
		}
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 0, 
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__143; std_stdstringview_make(&__chx__lv__143, self); &__chx__lv__143; }));
	_Bool __chx__lv__144 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__14 __chx__lv__145; std_stdstringto_float(&__chx__lv__145, &s); &__chx__lv__145; }));
	if(__chx__lv__144) {
...
void std_stdstring_viewto_double(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__146; std_stdstring_viewconstructor(&__chx__lv__146, "empty string", 12); &__chx__lv__146; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__147; std_stdstring_viewconstructor(&__chx__lv__147, "invalid format", 14); &__chx__lv__147; }))
			};
			return;
		}
		while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__148; std_stdstring_viewconstructor(&__chx__lv__148, "trailing characters", 19); &__chx__lv__148; }))
			};
			return;
		}
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 0, 
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__149; std_stdstringview_make(&__chx__lv__149, self); &__chx__lv__149; }));
	_Bool __chx__lv__150 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__15 __chx__lv__151; std_stdstringto_double(&__chx__lv__151, &s); &__chx__lv__151; }));
	if(__chx__lv__150) {
		std_stdstringdelete(&s);
	}
	return;
...
void std_stdstring_viewsplit(struct std_stdvector__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, char delim){
	struct std_stdvector__cgs__1 res = (*({ struct std_stdvector__cgs__1 __chx__lv__152; std_stdvector__cgs__1make(&__chx__lv__152); &__chx__lv__152; }));
	_Bool __chx__lv__153 = true;
	unsigned int start = 0;
	for(unsigned int i = 0;(i < self->_size);i++){
		if((std_stdstring_viewget(self, i) == delim)){
			std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__154; std_stdstring_viewsubview(&__chx__lv__154, self, start, i); &__chx__lv__154; })));
			start = (i + 1);
		}
	}
	if((start <= self->_size)){
		std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__155; std_stdstring_viewsubview(&__chx__lv__155, self, start, self->_size); &__chx__lv__155; })));
	}
	*__chx_struct_ret_param_xx = res;
	return;
}
void std_stdstring_viewto_string(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__156; std_stdstringview_make(&__chx__lv__156, self); &__chx__lv__156; }));
	return;
}
void std_stdstring_viewstream(struct std_stdstring_view*const self, struct std_stdStringStream* s){
...
void std_stdallocGlobalAllocatoralloc_zeroed(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout){
	struct std_stdResult__cgs__2 result = (*({ struct std_stdResult__cgs__2 __chx__lv__158; std_stdallocGlobalAllocatoralloc(&__chx__lv__158, self, ({ struct std_stdallocLayout __chx__lv__159 = *layout; &__chx__lv__159; })); &__chx__lv__158; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__2* __chx__lv__160 = &result;
...
void std_stdallocalloc_zeroed_bytes(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, size_t size){
	struct std_stdResult__cgs__2 result = (*({ struct std_stdResult__cgs__2 __chx__lv__161; std_stdallocalloc_bytes(&__chx__lv__161, size); &__chx__lv__161; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__2* __chx__lv__162 = &result;
