...
@test
public func test_md_header_renders(env : &mut TestEnv) {
...
@test
public func test_md_header_level_three(env : &mut TestEnv) {
...
@test
public func test_md_bold_and_italic(env : &mut TestEnv) {
...
@test
public func test_md_fenced_code_block(env : &mut TestEnv) {
...
@test
public func test_md_fenced_code_with_language(env : &mut TestEnv) {
...
@test
public func test_md_link_renders(env : &mut TestEnv) {
...
@test
public func test_md_image_renders(env : &mut TestEnv) {
...
@test
public func test_md_unordered_list(env : &mut TestEnv) {
...
@test
public func test_md_ordered_list(env : &mut TestEnv) {
...
@test
public func test_md_nested_list(env : &mut TestEnv) {
...
@test
public func test_md_task_checkbox(env : &mut TestEnv) {
...
@test
public func test_md_blockquote(env : &mut TestEnv) {
...
@test
public func test_md_inline_code(env : &mut TestEnv) {
...
@test
public func test_md_table_renders(env : &mut TestEnv) {
...
@test
public func test_md_strikethrough(env : &mut TestEnv) {
...
@test
public func test_md_paragraph_break(env : &mut TestEnv) {
...
@test
public func test_md_highlighter_is_used(env : &mut TestEnv) {
    var input = std::string_view("```cpp\nint x;\n```")
...
@test
public func test_md_link_rewriter_is_used(env : &mut TestEnv) {
