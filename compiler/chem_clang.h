...
/** We don't need this because we aren't including any functions that require extern
#ifdef __cplusplus
...
/** Do not need struct declarations because we have direct access to clang's API
// ABI warning
...
/** We don't need these struct declarations, because we have direct access to Clang's API
...
/** We don't need these functions as we have direct access to clang's API
