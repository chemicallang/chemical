...
public func zip_find_entry_multiple(env : &mut TestEnv) {
    ...
    var entry1 : archive::ArchiveEntry = archive::ArchiveEntry { name: string(""), size: 0, compressed_size: 0, compression_method: 0, crc32: 0, is_directory: false, offset: 0 }
    var r1 = archive::zip_find_entry(&raw mut a, "x.txt\0" as *char, &raw mut entry1)
    if(r1 is Result.Err) { env.error("should find x.txt") }

    var entry2 : archive::ArchiveEntry = archive::ArchiveEntry { name: string(""), size: 0, compressed_size: 0, compression_method: 0, crc32: 0, is_directory: false, offset: 0 }
