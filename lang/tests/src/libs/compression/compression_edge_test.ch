...
func test_rle_max_run(env : &mut TestEnv) {
    ...
    unsafe var input : [255]u8;
    var i : size_t = 0;
    while(i < 255) { input[i] = 0xAB; i += 1; }
    unsafe var compressed : [512]u8;
    var comp_len : size_t = 0;
    ...
    unsafe var decompressed : [512]u8;
    var dec_len : size_t = 0;
