func putToken(analyzer : &mut SemanticTokensAnalyzer, token : *mut Token) {
    switch(token.type) {
        JsTokenType.Var, JsTokenType.Const, JsTokenType.Let, JsTokenType.State, JsTokenType.Function, JsTokenType.Return,
...
@no_mangle
public func universal_semanticTokensPut(analyzer : &mut SemanticTokensAnalyzer, start : *mut Token, end : *Token) : *Token {
