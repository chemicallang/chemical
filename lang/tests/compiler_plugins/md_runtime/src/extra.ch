@test
public func test_md_horizontal_rule(env : &mut TestEnv) {
...
@test
public func test_md_heading_with_bold(env : &mut TestEnv) {
...
@test
public func test_md_bold_containing_link(env : &mut TestEnv) {
...
@test
public func test_md_ordered_list_offset_start(env : &mut TestEnv) {
...
@test
public func test_md_multiple_heading_levels(env : &mut TestEnv) {
...
@test
public func test_md_paragraph_then_list(env : &mut TestEnv) {
...
@test
public func test_md_all_heading_levels(env : &mut TestEnv) {
...
@test
public func test_md_code_block_contains_tick(env : &mut TestEnv) {
...
@test
public func test_md_two_links_in_paragraph(env : &mut TestEnv) {
...
@test
public func test_md_html_escaping_angle_brackets(env : &mut TestEnv) {
...
@test
public func test_md_html_escaping_ampersand(env : &mut TestEnv) {
...
@test
public func test_md_html_escaping_quotes(env : &mut TestEnv) {
...
@test
public func test_md_code_block_html_not_escaped(env : &mut TestEnv) {
...
@test
public func test_md_inline_code_html_escaped(env : &mut TestEnv) {
...
@test
public func test_md_image_alt_html_escaped(env : &mut TestEnv) {
...
@test
public func test_md_link_title_html_escaped(env : &mut TestEnv) {
...
@test
public func test_md_superscript_and_subscript(env : &mut TestEnv) {
...
@test
public func test_md_insert_and_mark(env : &mut TestEnv) {
