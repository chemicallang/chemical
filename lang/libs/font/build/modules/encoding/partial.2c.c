...
void encoding_encodinghex_decode_to_vec(struct std_stdResult__cgs__30* __chx_struct_ret_param_xx, struct std_stdstring_view* hex){
	...
	struct std_stdvector__cgs__3 vec = (*({ struct std_stdvector__cgs__3 __chx__lv__0; std_stdvector__cgs__3make(&__chx__lv__0); &__chx__lv__0; }));
	...
	*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__30) { .__chx__vt_621827 = 0, 
		.Ok.value = ({ __chx__lv__1 = false; vec; })
	};
	if(__chx__lv__1) {
		std_stdvector__cgs__3delete(&vec);
	}
...
void encoding_encodingEncodingErrormessage(struct std_stdstring* __chx_struct_ret_param_xx, struct encoding_encodingEncodingError*const self){
	switch((self)->__chx__vt_621827) {
		case 0:{
			struct std_stdstring s = (*({ struct std_stdstring __chx__lv__2; std_stdstringconstructor2(&__chx__lv__2, "EncodingError: buffer too small, need ", 38, 0); &__chx__lv__2; }));
		...
		case 1:{
			*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__4; std_stdstringconstructor2(&__chx__lv__4, "EncodingError: invalid input", 28, 0); &__chx__lv__4; }));
			return;
			break;
		}
		case 2:{
			*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__5; std_stdstringconstructor2(&__chx__lv__5, "EncodingError: unsupported operation", 36, 0); &__chx__lv__5; }));
			return;
			break;
		}
	}
