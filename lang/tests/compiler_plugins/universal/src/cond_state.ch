...
public func universal_precedence_or_cond_ssr_has(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<div id="u${page.getComponentId(0)}"><div>Has</div></div>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_precedence_or_cond_ssr_none(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<div id="u${page.getComponentId(0)}"><div>None</div></div>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_precedence_arith_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<div id="u${page.getComponentId(0)}"><div>7</div></div>`)
    view_equals(env, page.getHtml(), html.to_view())
}
