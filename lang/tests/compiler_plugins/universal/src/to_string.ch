...
public func universal_element_in_html_works(env : &mut TestEnv) {
    ...
    var str = std::string();
    str.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><span>Hello</span></span>`);
...
public func universal_class_merge(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div class="extra base-class"></div></span>`)
...
public func universal_button_variant(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><button class="btn-primary btn-base">Click Me</button></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_deep_prop_passing(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div title="Hover Me"><span>Text</span></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_multi_child(env : &mut TestEnv) {
    ...
    #html { <MultiChild /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div><span>A</span><span>B</span></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_nested_universal_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><span>Hello</span></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_nested_universal_props_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div title="T"><span>L</span></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_spread_and_static_attr_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div title="Hello" id="static" data-val="123"></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_frag_parent_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><span>Hello</span><div>Middle</div><span>Hello</span></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_attr_chem_value_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div data-val="42"></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_state(env : &mut TestEnv) {
    ...
    #html { <SsrMapState /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>a</li><li>b</li><li>c</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_props(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>One</li><li>Two</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_numbers(env : &mut TestEnv) {
    ...
    #html { <SsrMapNumbers /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>2</li><li>3</li><li>4</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_block_body(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>x</li><li>y</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_inline_literal(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>10</li><li>20</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_len_state(env : &mut TestEnv) {
    ...
    #html { <SsrLenState /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div>2 items</div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_len_props(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div>4 items</div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_local_var(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>A</li><li>B</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_concat(env : &mut TestEnv) {
    ...
    #html { <SsrMapConcat /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div>a!b!c!</div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_spread_duplicate_attr_ssr(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div title="static"></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_index_state(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>0:a</li><li>1:b</li><li>2:c</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_index_num(env : &mut TestEnv) {
    ...
    #html { <SsrMapIndexNum /> }
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>1.a</li><li>2.b</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_map_index_props(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><ul><li>0:One</li><li>1:Two</li></ul></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_state_ternary(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div>YES</div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_state_attr_ternary(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><span style="color:blue;">t</span></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_state_index_compare(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div><button style="">A</button><button style="active">B</button><button style="">C</button></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_ssr_state_props_init(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><div><span style="off">x</span><span style="off">y</span><span style="on">z</span></div></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func test_simple_button_works(env : &mut TestEnv) {
    ...
    var html = std::string()
    html.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><button class="my_class dc_2 dc_1">Hello</button></span>`)
    view_equals(env, page.getHtml(), html.to_view())
}
...
public func universal_multiple_in_html(env : &mut TestEnv) {
    ...
    var str = std::string();
    str.append_expr(`<span id="u${page.getComponentId(0)}" data-chx-i><span>Hello</span></span><span id="u${page.getComponentId(1)}" data-chx-i><span>Hello</span></span>`);
    view_equals(env, page.getHtml(), str.to_view());
}
