...
void std_stdResult__cgs__9delete(struct std_stdResult__cgs__9* self);
struct std_stdvector__cgs__2 {
	cstd_usize* data_ptr;
	size_t data_size;
	size_t data_cap;
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
typedef struct __chx_std_stdallocAllocator_vt_t {
	void(*alloc)(void* self, struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocLayout* layout);void(*dealloc)(void* self, void* ptr, struct std_stdallocLayout* layout);void(*grow)(void* self, struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, void* old, struct std_stdallocLayout* old_layout, size_t new_size);void(*shrink)(void* self, struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, void* old, struct std_stdallocLayout* old_layout, size_t new_size);
...
void std_stdallocGlobalAllocatoralloc(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout);
...
void std_stdallocGlobalAllocatorgrow(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, void* old, struct std_stdallocLayout* old_layout, size_t new_size);
void std_stdallocGlobalAllocatorshrink(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, void* old, struct std_stdallocLayout* old_layout, size_t new_size);
void std_stdallocGlobalAllocatoralloc_zeroed(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout);
...
void std_stdallocalloc_bytes(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, size_t size);
void std_stdallocdealloc_bytes(void* ptr);
void std_stdallocalloc_zeroed_bytes(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, size_t size);
...
void std_stdstringto_u64(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
const struct std_stdconcurrentTask* core_coreiterableLinear__cgs__0_vector__cgs__0_data(struct std_stdvector__cgs__0*const self){
	return self->data_ptr;
}
...
const __chx_core_coreiterableLinear__cgs__0_vt_t core_coreiterableLinear__cgs__0std_stdvector__cgs__0 = {
	(const struct std_stdconcurrentTask*(*)(void* self)) core_coreiterableLinear__cgs__0_vector__cgs__0_data,
...
const struct std_stdstring_view* core_coreiterableLinear__cgs__1_vector__cgs__1_data(struct std_stdvector__cgs__1*const self){
	return self->data_ptr;
}
...
const __chx_core_coreiterableLinear__cgs__1_vt_t core_coreiterableLinear__cgs__1std_stdvector__cgs__1 = {
	(const struct std_stdstring_view*(*)(void* self)) core_coreiterableLinear__cgs__1_vector__cgs__1_data,
...
void std_stdget_env(struct std_stdOption__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const name){
	...
	*__chx_struct_ret_param_xx = (struct std_stdOption__cgs__0) { .__chx__vt_621827 = 0, 
		.Some.value = (*({ struct std_stdstring __chx__lv__8; std_stdstringmake_no_len(&__chx__lv__8, ptr); &__chx__lv__8; }))
	};
	return;
}
...
void std_stdu16stringsubstr(struct std_stdu16string* __chx_struct_ret_param_xx, struct std_stdu16string*const self, size_t start, size_t len){
	struct std_stdu16string result = (*({ struct std_stdu16string __chx__lv__12; std_stdu16stringempty_str(&__chx__lv__12); &__chx__lv__12; }));
	...
	buf[real_len] = 0;
	struct std_stdu16string __chx__lv__14 = (*({ struct std_stdu16string __chx__lv__15; std_stdu16stringconstructor(&__chx__lv__15, buf, real_len); &__chx__lv__15; }));
	*__chx_struct_ret_param_xx = result;
	std_stdu16stringdelete(&__chx__lv__14);
	return;
}
void std_stdu16stringto_utf8(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdu16string*const self){
	size_t n = std_stdu16stringsize(self);
	if((n == 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__16; std_stdstringempty_str(&__chx__lv__16); &__chx__lv__16; }));
		return;
	}
	unsigned long out_cap = ((n * 3) + 1);
	struct std_stdstring out = (*({ struct std_stdstring __chx__lv__17; std_stdstringempty_str(&__chx__lv__17); &__chx__lv__17; }));
...
int std_stdu16stringfind(struct std_stdu16string*const self, struct std_stdu16string* sub){
	...
	if((m == 0)){
		const int __chx__lv__20 = 0;
		if(__chx__lv__19) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__20;
	}
	if((m > n)){
		const int __chx__lv__21 = -1;
		if(__chx__lv__19) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__21;
	}
	const uint16_t* src = std_stdu16stringdata(self);
...
_Bool std_stdu16stringstarts_with(struct std_stdu16string*const self, struct std_stdu16string* prefix){
	...
	while((i < p_len)) {
		if((src[i] != pre[i])){
			const _Bool __chx__lv__26 = 0;
			if(__chx__lv__24) {
				std_stdu16stringdelete(prefix);
			}
			return __chx__lv__26;
		}
		i = (i + 1);
	}
	const _Bool __chx__lv__27 = 1;
	if(__chx__lv__24) {
		std_stdu16stringdelete(prefix);
	}
...
static void __chemda_341_0(void* this){
}
cstd_usize std_stdconcurrenthardware_threads(){
...
static const void* std_stdconcurrentworker_main(const void* arg){
	...
	while(1) {
		...
		if((std_stdvector__cgs__0size(&P->q) > 0)){
			...
			struct std_stdconcurrentTask t = (*({ struct std_stdconcurrentTask __chx__lv__32; std_stdreplace__cfg_0(&__chx__lv__32, &*first_ele, &(struct std_stdconcurrentTask){ 
				.f = *({ __chemical_fat_pointer__* __chemda_341_0_pair = &(__chemical_fat_pointer__){__chemda_341_0,NULL}; &(*({ struct std_stddefault_function_instance __chx__lv__33; std_stddefault_function_instancemake2(&__chx__lv__33, __chemda_341_0_pair->first, __chemda_341_0_pair->second, ((std_stddestructor_type) NULL), 0, 0); &__chx__lv__33; })); })
			}); &__chx__lv__32; }));
		...
		if((opt.__chx__vt_621827 == 0)){
			struct std_stdOption__cgs__1* __chx__lv__34 = &opt;
			({ struct std_stddefault_function_instance* __chx__lv__35 = &__chx__lv__34->Some.value.f; ((void(*)(void*))std_stddefault_function_instanceget_fn_ptr(__chx__lv__35))(std_stddefault_function_instanceget_data_ptr(__chx__lv__35)); });
		}
	}
	return NULL;
}
...
void std_stdconcurrentThreadPoolsubmit_void(struct std_stdconcurrentThreadPool*const self, std_stdfunction* f){
	...
	std_stdconcurrentPoolDatasubmit_void(self->data, ({ __chx__lv__37 = false; &*f; }));
	if(__chx__lv__37) {
		std_stddefault_function_instancedelete(f);
	}
}
void std_stdconcurrentThreadPooldelete(struct std_stdconcurrentThreadPool*const self){
	struct std_stdconcurrentPoolData*__chx__lv__38 = self->data;
	
	std_stdconcurrentPoolDatadelete(__chx__lv__38);
	free(__chx__lv__38);
	__chx__dstctr_clnup_blk__:{
	}
}
void std_stdconcurrentcreate_pool(struct std_stdconcurrentThreadPool* __chx_struct_ret_param_xx, unsigned int n){
	...
	({ struct std_stdconcurrentPoolData* __chx__lv__39 = p; *__chx__lv__39 = (struct std_stdconcurrentPoolData){ 
		.m = (*({ struct std_stdmutex __chx__lv__40; std_stdmutexconstructor(&__chx__lv__40); &__chx__lv__40; })), 
		.cv = (*({ struct std_stdCondVar __chx__lv__41; std_stdCondVarconstructor(&__chx__lv__41); &__chx__lv__41; })), 
		.q = (*({ struct std_stdvector__cgs__0 __chx__lv__42; std_stdvector__cgs__0make(&__chx__lv__42); &__chx__lv__42; })), 
		.workers = (*({ struct std_stdvector__cgs__2 __chx__lv__43; std_stdvector__cgs__2make(&__chx__lv__43); &__chx__lv__43; })), 
		.run = 1
	}; __chx__lv__39; });
	unsigned int i = 0;
	while((i < n)) {
...
void std_stdchronoDurationmul_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__44; std_stdchronoDurationfrom_nanos(&__chx__lv__44, result_nanos); &__chx__lv__44; }));
	return;
}
void std_stdchronoDurationdiv_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	if((scalar == 0)){
	...
	int64_t total_nanos = std_stdchronoDurationas_nanos(self);
	int64_t result_nanos = (total_nanos / scalar);
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__45; std_stdchronoDurationfrom_nanos(&__chx__lv__45, result_nanos); &__chx__lv__45; }));
	return;
}
void std_stdchronoDurationabs(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self){
	if((self->secs < 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__46; std_stdchronoDurationneg(&__chx__lv__46, self); &__chx__lv__46; }));
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdchronoDuration){ 
		.secs = self->secs, 
...
void std_stdchronoInstantduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__47; std_stdchronoDurationfrom_parts(&__chx__lv__47, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__47; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoInstantelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self){
	struct std_stdchronoInstant now_inst = (*({ struct std_stdchronoInstant __chx__lv__48; std_stdchronoInstantnow(&__chx__lv__48); &__chx__lv__48; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__49; std_stdchronoInstantduration_since(&__chx__lv__49, &now_inst, self); &__chx__lv__49; }));
	return;
}
void std_stdchronoInstantduration_to(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const later){
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__50; std_stdchronoInstantduration_since(&__chx__lv__50, later, self); &__chx__lv__50; }));
	return;
}
void std_stdchronoInstantadd_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__51; std_stdchronoDurationfrom_parts(&__chx__lv__51, self->secs, self->nanos); &__chx__lv__51; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__52; std_stdchronoDurationadd(&__chx__lv__52, &d, dur); &__chx__lv__52; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoInstantsub_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__53; std_stdchronoDurationfrom_parts(&__chx__lv__53, self->secs, self->nanos); &__chx__lv__53; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__54; std_stdchronoDurationsub(&__chx__lv__54, &d, dur); &__chx__lv__54; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoSystemTimefrom_unix_epoch_nanos(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, int64_t secs, int64_t nanos){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__55; std_stdchronoDurationfrom_parts(&__chx__lv__55, secs, nanos); &__chx__lv__55; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
...
void std_stdchronoSystemTimeduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoSystemTime*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__56; std_stdchronoDurationfrom_parts(&__chx__lv__56, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__56; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoSystemTimeelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self){
	struct std_stdchronoSystemTime now_st = (*({ struct std_stdchronoSystemTime __chx__lv__57; std_stdchronoSystemTimenow(&__chx__lv__57); &__chx__lv__57; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__58; std_stdchronoSystemTimeduration_since(&__chx__lv__58, &now_st, self); &__chx__lv__58; }));
	return;
}
void std_stdchronoSystemTimeadd_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__59; std_stdchronoDurationfrom_parts(&__chx__lv__59, self->secs, self->nanos); &__chx__lv__59; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__60; std_stdchronoDurationadd(&__chx__lv__60, &d, dur); &__chx__lv__60; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&sum), 
		.nanos = std_stdchronoDurationsubsec_nanos(&sum)
	};
...
void std_stdchronoSystemTimesub_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__61; std_stdchronoDurationfrom_parts(&__chx__lv__61, self->secs, self->nanos); &__chx__lv__61; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__62; std_stdchronoDurationsub(&__chx__lv__62, &d, dur); &__chx__lv__62; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&diff), 
		.nanos = std_stdchronoDurationsubsec_nanos(&diff)
	};
...
void std_stdstring_viewsubview(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t start, size_t end){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__63; std_stdstring_viewconstructor(&__chx__lv__63, (self->_data + start), (end - start)); &__chx__lv__63; }));
	return;
}
void std_stdstring_viewskip(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t count){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__64; std_stdstring_viewconstructor(&__chx__lv__64, (self->_data + count), (self->_size - count)); &__chx__lv__64; }));
	return;
}
size_t std_stdstring_viewfind(struct std_stdstring_view*const self, struct std_stdstring_view*const needle){
...
void std_stdstring_viewtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((s == self->_size)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__65; std_stdstring_viewconstructor(&__chx__lv__65, "", 0); &__chx__lv__65; }));
		return;
	}
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__66; std_stdstring_viewsubview(&__chx__lv__66, self, s, (e + 1)); &__chx__lv__66; }));
	return;
}
void std_stdstring_viewto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__67; std_stdstring_viewto_i64(&__chx__lv__67, self); &__chx__lv__67; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int8_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__68; std_stdstring_viewto_i64(&__chx__lv__68, self); &__chx__lv__68; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__0) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__69; std_stdstring_viewto_i64(&__chx__lv__69, self); &__chx__lv__69; }))).Err.error
			};
			return;
			break;
		}
	...
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__70; std_stdstring_viewto_i64(&__chx__lv__70, self); &__chx__lv__70; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__4) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int16_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__71; std_stdstring_viewto_i64(&__chx__lv__71, self); &__chx__lv__71; }))).Ok.value)
			};
			return;
			break;
		}
	...
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__73; std_stdstring_viewto_i64(&__chx__lv__73, self); &__chx__lv__73; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__5) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int32_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__74; std_stdstring_viewto_i64(&__chx__lv__74, self); &__chx__lv__74; }))).Ok.value)
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__76; std_stdstring_viewconstructor(&__chx__lv__76, "empty string", 12); &__chx__lv__76; }))
		};
		return;
	}
	if((self->_data[i] == '-')){
...
void std_stdstring_viewto_u8(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__12 __chx__lv__79; std_stdstring_viewto_u64(&__chx__lv__79, self); &__chx__lv__79; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint8_t) ((*({ struct std_stdResult__cgs__12 __chx__lv__80; std_stdstring_viewto_u64(&__chx__lv__80, self); &__chx__lv__80; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__12 __chx__lv__81; std_stdstring_viewto_u64(&__chx__lv__81, self); &__chx__lv__81; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u16(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__12 __chx__lv__82; std_stdstring_viewto_u64(&__chx__lv__82, self); &__chx__lv__82; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint16_t) ((*({ struct std_stdResult__cgs__12 __chx__lv__83; std_stdstring_viewto_u64(&__chx__lv__83, self); &__chx__lv__83; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__12 __chx__lv__84; std_stdstring_viewto_u64(&__chx__lv__84, self); &__chx__lv__84; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__12 __chx__lv__85; std_stdstring_viewto_u64(&__chx__lv__85, self); &__chx__lv__85; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint32_t) ((*({ struct std_stdResult__cgs__12 __chx__lv__86; std_stdstring_viewto_u64(&__chx__lv__86, self); &__chx__lv__86; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__11) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__12 __chx__lv__87; std_stdstring_viewto_u64(&__chx__lv__87, self); &__chx__lv__87; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__88; std_stdstring_viewconstructor(&__chx__lv__88, "empty string", 12); &__chx__lv__88; }))
		};
		return;
	}
	if((self->_data[i] == '+')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__89; std_stdstring_viewconstructor(&__chx__lv__89, "invalid format", 14); &__chx__lv__89; }))
		};
		return;
	}
	while(((i < self->_size) && isdigit(self->_data[i]))) {
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__90; std_stdstring_viewconstructor(&__chx__lv__90, "trailing characters", 19); &__chx__lv__90; }))
		};
		return;
	}
...
void std_stdstring_viewto_int(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__5 __chx__lv__91; std_stdstring_viewto_i32(&__chx__lv__91, self); &__chx__lv__91; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int) ((*({ struct std_stdResult__cgs__5 __chx__lv__92; std_stdstring_viewto_i32(&__chx__lv__92, self); &__chx__lv__92; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__13) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__5 __chx__lv__93; std_stdstring_viewto_i32(&__chx__lv__93, self); &__chx__lv__93; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__11 __chx__lv__94; std_stdstring_viewto_u32(&__chx__lv__94, self); &__chx__lv__94; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 0, 
				.Ok.value = ((unsigned int) ((*({ struct std_stdResult__cgs__11 __chx__lv__95; std_stdstring_viewto_u32(&__chx__lv__95, self); &__chx__lv__95; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__11 __chx__lv__96; std_stdstring_viewto_u32(&__chx__lv__96, self); &__chx__lv__96; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__97; std_stdstring_viewconstructor(&__chx__lv__97, "empty string", 12); &__chx__lv__97; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__98; std_stdstring_viewconstructor(&__chx__lv__98, "invalid format", 14); &__chx__lv__98; }))
			};
			return;
		}
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__99; std_stdstring_viewconstructor(&__chx__lv__99, "trailing characters", 19); &__chx__lv__99; }))
			};
			return;
		}
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__100; std_stdstringview_make(&__chx__lv__100, self); &__chx__lv__100; }));
	_Bool __chx__lv__101 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__15 __chx__lv__102; std_stdstringto_float(&__chx__lv__102, &s); &__chx__lv__102; }));
	if(__chx__lv__101) {
...
void std_stdstring_viewto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__103; std_stdstring_viewconstructor(&__chx__lv__103, "empty string", 12); &__chx__lv__103; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__104; std_stdstring_viewconstructor(&__chx__lv__104, "invalid format", 14); &__chx__lv__104; }))
			};
			return;
		}
		while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__105; std_stdstring_viewconstructor(&__chx__lv__105, "trailing characters", 19); &__chx__lv__105; }))
			};
			return;
		}
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__106; std_stdstringview_make(&__chx__lv__106, self); &__chx__lv__106; }));
	_Bool __chx__lv__107 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__16 __chx__lv__108; std_stdstringto_double(&__chx__lv__108, &s); &__chx__lv__108; }));
	if(__chx__lv__107) {
		std_stdstringdelete(&s);
	}
	return;
...
void std_stdstring_viewsplit(struct std_stdvector__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, char delim){
	struct std_stdvector__cgs__1 res = (*({ struct std_stdvector__cgs__1 __chx__lv__109; std_stdvector__cgs__1make(&__chx__lv__109); &__chx__lv__109; }));
	_Bool __chx__lv__110 = true;
	unsigned int start = 0;
	for(unsigned int i = 0;(i < self->_size);i++){
		if((std_stdstring_viewget(self, i) == delim)){
			std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__111; std_stdstring_viewsubview(&__chx__lv__111, self, start, i); &__chx__lv__111; })));
			start = (i + 1);
		}
	}
	if((start <= self->_size)){
		std_stdvector__cgs__1push(&res, &(*({ struct std_stdstring_view __chx__lv__112; std_stdstring_viewsubview(&__chx__lv__112, self, start, self->_size); &__chx__lv__112; })));
	}
	*__chx_struct_ret_param_xx = res;
	return;
}
void std_stdstring_viewto_string(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__113; std_stdstringview_make(&__chx__lv__113, self); &__chx__lv__113; }));
	return;
}
void std_stdstring_viewstream(struct std_stdstring_view*const self, struct std_stdStringStream* s){
...
void std_stdallocGlobalAllocatoralloc_zeroed(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdallocGlobalAllocator*const self, struct std_stdallocLayout* layout){
	struct std_stdResult__cgs__2 result = (*({ struct std_stdResult__cgs__2 __chx__lv__115; std_stdallocGlobalAllocatoralloc(&__chx__lv__115, self, ({ struct std_stdallocLayout __chx__lv__116 = *layout; &__chx__lv__116; })); &__chx__lv__115; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__2* __chx__lv__117 = &result;
	memset(__chx__lv__117->Ok.value, 0, layout->size);
	*__chx_struct_ret_param_xx = result;
	return;
}
void std_stdallocGlobalAllocatorcheck_leaks(struct std_stdallocGlobalAllocator*const self){
...
void std_stdallocalloc_zeroed_bytes(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, size_t size){
	struct std_stdResult__cgs__2 result = (*({ struct std_stdResult__cgs__2 __chx__lv__118; std_stdallocalloc_bytes(&__chx__lv__118, size); &__chx__lv__118; }));
	if((result.__chx__vt_621827 == 1)){
		*__chx_struct_ret_param_xx = result;
		return;
	}
	struct std_stdResult__cgs__2* __chx__lv__119 = &result;
	memset(__chx__lv__119->Ok.value, 0, size);
	*__chx_struct_ret_param_xx = result;
	return;
}
...
void std_stdstringview_make2(struct std_stdstring* this, struct std_stdstring_view* value){
	*this = (*({ struct std_stdstring __chx__lv__123; std_stdstringview_make(&__chx__lv__123, value); &__chx__lv__123; }));
	return;
}
void std_stdstringconstructor2(struct std_stdstring* this, const char* value, size_t length, _Bool ensure){
	struct std_stdstring s = (struct std_stdstring){ 
...
void std_stdstringappend_double(struct std_stdstring* self, double value, int precision){
	...
	if(std_stddbl_is_nan(value)){
		std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__127; std_stdstring_viewconstructor(&__chx__lv__127, "nan", 3); &__chx__lv__127; })));
		return;
	}
	if(std_stddbl_is_inf(value)){
		if(std_stddbl_is_neg(value)){
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__128; std_stdstring_viewconstructor(&__chx__lv__128, "-inf", 4); &__chx__lv__128; })));
		} else {
			std_stdstringappend_view(self, &(*({ struct std_stdstring_view __chx__lv__129; std_stdstring_viewconstructor(&__chx__lv__129, "inf", 3); &__chx__lv__129; })));
		}
		return;
	}
	double v = value;
...
void std_stdstringcopy(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__130; std_stdstringsubstring(&__chx__lv__130, self, 0, std_stdstringsize(self)); &__chx__lv__130; }));
	return;
}
void std_stdstringsubstring(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self, size_t start, size_t end){
...
size_t std_stdstringfind(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__132; std_stdstring_viewconstructor(&__chx__lv__132, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__132; }));
	return std_stdinternal_view_find(&view, needle);
}
size_t std_stdstringfind_last(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__133; std_stdstring_viewconstructor(&__chx__lv__133, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__133; }));
...
void std_stdstringtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__134; std_stdstring_viewtrim(&__chx__lv__134, &(*({ struct std_stdstring_view __chx__lv__135; std_stdstringto_view(&__chx__lv__135, self); &__chx__lv__135; }))); &__chx__lv__134; }));
	return;
}
void std_stdstringsplit(struct std_stdvector__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring*const self, char delim){
	*__chx_struct_ret_param_xx = (*({ struct std_stdvector__cgs__1 __chx__lv__136; std_stdstring_viewsplit(&__chx__lv__136, &(*({ struct std_stdstring_view __chx__lv__137; std_stdstringto_view(&__chx__lv__137, self); &__chx__lv__137; })), delim); &__chx__lv__136; }));
	return;
}
_Bool std_stdstringends_with(struct std_stdstring*const self, struct std_stdstring_view*const other){
	if((std_stdstring_viewsize(other) > std_stdstringsize(self))){
...
void std_stdstringto_view(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__138; std_stdstring_viewconstructor(&__chx__lv__138, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__138; }));
	return;
}
void std_stdstringto_i8(struct std_stdResult__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__0 __chx__lv__139; std_stdstring_viewto_i8(&__chx__lv__139, &(*({ struct std_stdstring_view __chx__lv__140; std_stdstringto_view(&__chx__lv__140, self); &__chx__lv__140; }))); &__chx__lv__139; }));
	return;
}
void std_stdstringto_i16(struct std_stdResult__cgs__4* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__4 __chx__lv__141; std_stdstring_viewto_i16(&__chx__lv__141, &(*({ struct std_stdstring_view __chx__lv__142; std_stdstringto_view(&__chx__lv__142, self); &__chx__lv__142; }))); &__chx__lv__141; }));
	return;
}
void std_stdstringto_i32(struct std_stdResult__cgs__5* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__5 __chx__lv__143; std_stdstring_viewto_i32(&__chx__lv__143, &(*({ struct std_stdstring_view __chx__lv__144; std_stdstringto_view(&__chx__lv__144, self); &__chx__lv__144; }))); &__chx__lv__143; }));
	return;
}
void std_stdstringto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__6 __chx__lv__145; std_stdstring_viewto_i64(&__chx__lv__145, &(*({ struct std_stdstring_view __chx__lv__146; std_stdstringto_view(&__chx__lv__146, self); &__chx__lv__146; }))); &__chx__lv__145; }));
	return;
}
void std_stdstringto_u8(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__8 __chx__lv__147; std_stdstring_viewto_u8(&__chx__lv__147, &(*({ struct std_stdstring_view __chx__lv__148; std_stdstringto_view(&__chx__lv__148, self); &__chx__lv__148; }))); &__chx__lv__147; }));
	return;
}
void std_stdstringto_u16(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__10 __chx__lv__149; std_stdstring_viewto_u16(&__chx__lv__149, &(*({ struct std_stdstring_view __chx__lv__150; std_stdstringto_view(&__chx__lv__150, self); &__chx__lv__150; }))); &__chx__lv__149; }));
	return;
}
void std_stdstringto_u32(struct std_stdResult__cgs__11* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__11 __chx__lv__151; std_stdstring_viewto_u32(&__chx__lv__151, &(*({ struct std_stdstring_view __chx__lv__152; std_stdstringto_view(&__chx__lv__152, self); &__chx__lv__152; }))); &__chx__lv__151; }));
	return;
}
void std_stdstringto_u64(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__12 __chx__lv__153; std_stdstring_viewto_u64(&__chx__lv__153, &(*({ struct std_stdstring_view __chx__lv__154; std_stdstringto_view(&__chx__lv__154, self); &__chx__lv__154; }))); &__chx__lv__153; }));
	return;
}
void std_stdstringto_int(struct std_stdResult__cgs__13* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__13 __chx__lv__155; std_stdstring_viewto_int(&__chx__lv__155, &(*({ struct std_stdstring_view __chx__lv__156; std_stdstringto_view(&__chx__lv__156, self); &__chx__lv__156; }))); &__chx__lv__155; }));
	return;
}
void std_stdstringto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__14 __chx__lv__157; std_stdstring_viewto_uint(&__chx__lv__157, &(*({ struct std_stdstring_view __chx__lv__158; std_stdstringto_view(&__chx__lv__158, self); &__chx__lv__158; }))); &__chx__lv__157; }));
	return;
}
void std_stdstringto_float(struct std_stdResult__cgs__15* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	char* end = NULL;
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__159; std_stdstring_viewconstructor(&__chx__lv__159, "invalid format", 14); &__chx__lv__159; }))
		};
		return;
	}
	while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__160; std_stdstring_viewconstructor(&__chx__lv__160, "trailing characters", 19); &__chx__lv__160; }))
		};
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__15) { .__chx__vt_621827 = 0, 
...
void std_stdstringto_double(struct std_stdResult__cgs__16* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__161; std_stdstring_viewconstructor(&__chx__lv__161, "invalid format", 14); &__chx__lv__161; }))
		};
		return;
	}
	while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__162; std_stdstring_viewconstructor(&__chx__lv__162, "trailing characters", 19); &__chx__lv__162; }))
		};
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__16) { .__chx__vt_621827 = 0, 
