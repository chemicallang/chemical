public struct AtomicU64 {
    ...
    public comptime func compare_exchange_weak(&mut self, expected: *mut u64, v: u64,
    ...
    public comptime func compare_exchange_strong(&mut self, expected: *mut u64, v: u64,
        success_order: memory_order = memory_order.seq_cst,
        failure_order: memory_order = memory_order.seq_cst
    ) : bool {
