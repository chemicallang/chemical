...
const struct std_stdstring_view* core_coreiterableLinear__cgs__0_span__cgs__3_data(struct std_stdspan__cgs__3*const self){
	return self->_data;
}
size_t core_coreiterableLinear__cgs__0_span__cgs__3_size(struct std_stdspan__cgs__3*const self){
	return self->_size;
}
const __chx_core_coreiterableLinear__cgs__0_vt_t core_coreiterableLinear__cgs__0std_stdspan__cgs__3 = {
	(const struct std_stdstring_view*(*)(void* self)) core_coreiterableLinear__cgs__0_span__cgs__3_data,
	(uint64_t(*)(void* self)) core_coreiterableLinear__cgs__0_span__cgs__3_size,
};
void std_stdspan__cgs__4constructor(struct std_stdspan__cgs__4* this, const void*** array_ptr, size_t array_size){
