...
void std_stdResult__cgs__11delete(struct std_stdResult__cgs__11* self);
struct std_stdResult__cgs__12 {
	int __chx__vt_621827;
	union {
		struct {
...
void std_stdResult__cgs__16delete(struct std_stdResult__cgs__16* self);
struct std_stdResult__cgs__17 {
	int __chx__vt_621827;
	union {
		struct {
...
void std_stdstringto_i32(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
void std_stdstringto_u64(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self);
void std_stdstringto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self);
...
void std_stdstring_viewto_i32(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
void std_stdstring_viewto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self);
...
void std_stdu16stringsubstr(struct std_stdu16string* __chx_struct_ret_param_xx, struct std_stdu16string*const self, size_t start, size_t len){
	struct std_stdu16string result = (*({ struct std_stdu16string __chx__lv__14; std_stdu16stringempty_str(&__chx__lv__14); &__chx__lv__14; }));
	_Bool __chx__lv__15 = true;
	...
	buf[real_len] = 0;
	struct std_stdu16string __chx__lv__16 = (*({ struct std_stdu16string __chx__lv__17; std_stdu16stringconstructor(&__chx__lv__17, buf, real_len); &__chx__lv__17; }));
	*__chx_struct_ret_param_xx = result;
	std_stdu16stringdelete(&__chx__lv__16);
	return;
}
void std_stdu16stringto_utf8(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdu16string*const self){
	size_t n = std_stdu16stringsize(self);
	if((n == 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__18; std_stdstringempty_str(&__chx__lv__18); &__chx__lv__18; }));
		return;
	}
	unsigned long out_cap = ((n * 3) + 1);
	struct std_stdstring out = (*({ struct std_stdstring __chx__lv__19; std_stdstringempty_str(&__chx__lv__19); &__chx__lv__19; }));
	_Bool __chx__lv__20 = true;
...
int std_stdu16stringfind(struct std_stdu16string*const self, struct std_stdu16string* sub){
	...
	if((m == 0)){
		const int __chx__lv__22 = 0;
		if(__chx__lv__21) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__22;
	}
	if((m > n)){
		const int __chx__lv__23 = -1;
		if(__chx__lv__21) {
			std_stdu16stringdelete(sub);
		}
		return __chx__lv__23;
	}
	const uint16_t* src = std_stdu16stringdata(self);
	...
	while(((i + m) <= n)) {
		...
		if((j == m)){
			const int __chx__lv__24 = ((int) i);
			if(__chx__lv__21) {
				std_stdu16stringdelete(sub);
			}
			return __chx__lv__24;
		}
		i = (i + 1);
	}
	const int __chx__lv__25 = -1;
	if(__chx__lv__21) {
		std_stdu16stringdelete(sub);
	}
	return __chx__lv__25;
}
_Bool std_stdu16stringstarts_with(struct std_stdu16string*const self, struct std_stdu16string* prefix){
	...
	if((p_len > my_len)){
		const _Bool __chx__lv__27 = 0;
		if(__chx__lv__26) {
			std_stdu16stringdelete(prefix);
		}
		return __chx__lv__27;
	}
	const uint16_t* src = std_stdu16stringdata(self);
	...
	const _Bool __chx__lv__29 = 1;
	if(__chx__lv__26) {
		std_stdu16stringdelete(prefix);
	}
	return __chx__lv__29;
}
_Bool std_stdu16stringends_with(struct std_stdu16string*const self, struct std_stdu16string* suffix){
...
void std_stdstringview_make2(struct std_stdstring* this, struct std_stdstring_view* value){
	*this = (*({ struct std_stdstring __chx__lv__36; std_stdstringview_make(&__chx__lv__36, value); &__chx__lv__36; }));
	return;
}
void std_stdstringconstructor2(struct std_stdstring* this, const char* value, size_t length, _Bool ensure){
	struct std_stdstring s = (struct std_stdstring){ 
...
void std_stdstringcopy(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__43; std_stdstringsubstring(&__chx__lv__43, self, 0, std_stdstringsize(self)); &__chx__lv__43; }));
	return;
}
void std_stdstringsubstring(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring*const self, size_t start, size_t end){
...
size_t std_stdstringfind(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__45; std_stdstring_viewconstructor(&__chx__lv__45, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__45; }));
	return std_stdinternal_view_find(&view, needle);
}
size_t std_stdstringfind_last(struct std_stdstring*const self, struct std_stdstring_view*const needle){
	struct std_stdstring_view view = (*({ struct std_stdstring_view __chx__lv__46; std_stdstring_viewconstructor(&__chx__lv__46, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__46; }));
...
void std_stdstringtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__47; std_stdstring_viewtrim(&__chx__lv__47, &(*({ struct std_stdstring_view __chx__lv__48; std_stdstringto_view(&__chx__lv__48, self); &__chx__lv__48; }))); &__chx__lv__47; }));
	return;
}
void std_stdstringsplit(struct std_stdvector__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring*const self, char delim){
	*__chx_struct_ret_param_xx = (*({ struct std_stdvector__cgs__0 __chx__lv__49; std_stdstring_viewsplit(&__chx__lv__49, &(*({ struct std_stdstring_view __chx__lv__50; std_stdstringto_view(&__chx__lv__50, self); &__chx__lv__50; })), delim); &__chx__lv__49; }));
	return;
}
_Bool std_stdstringends_with(struct std_stdstring*const self, struct std_stdstring_view*const other){
	if((std_stdstring_viewsize(other) > std_stdstringsize(self))){
...
void std_stdstringto_view(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__51; std_stdstring_viewconstructor(&__chx__lv__51, std_stdstringdata(self), std_stdstringsize(self)); &__chx__lv__51; }));
	return;
}
void std_stdstringto_i8(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__1 __chx__lv__52; std_stdstring_viewto_i8(&__chx__lv__52, &(*({ struct std_stdstring_view __chx__lv__53; std_stdstringto_view(&__chx__lv__53, self); &__chx__lv__53; }))); &__chx__lv__52; }));
	return;
}
void std_stdstringto_i16(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__2 __chx__lv__54; std_stdstring_viewto_i16(&__chx__lv__54, &(*({ struct std_stdstring_view __chx__lv__55; std_stdstringto_view(&__chx__lv__55, self); &__chx__lv__55; }))); &__chx__lv__54; }));
	return;
}
void std_stdstringto_i32(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__3 __chx__lv__56; std_stdstring_viewto_i32(&__chx__lv__56, &(*({ struct std_stdstring_view __chx__lv__57; std_stdstringto_view(&__chx__lv__57, self); &__chx__lv__57; }))); &__chx__lv__56; }));
	return;
}
void std_stdstringto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__6 __chx__lv__58; std_stdstring_viewto_i64(&__chx__lv__58, &(*({ struct std_stdstring_view __chx__lv__59; std_stdstringto_view(&__chx__lv__59, self); &__chx__lv__59; }))); &__chx__lv__58; }));
	return;
}
void std_stdstringto_u8(struct std_stdResult__cgs__7* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__7 __chx__lv__60; std_stdstring_viewto_u8(&__chx__lv__60, &(*({ struct std_stdstring_view __chx__lv__61; std_stdstringto_view(&__chx__lv__61, self); &__chx__lv__61; }))); &__chx__lv__60; }));
	return;
}
void std_stdstringto_u16(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__8 __chx__lv__62; std_stdstring_viewto_u16(&__chx__lv__62, &(*({ struct std_stdstring_view __chx__lv__63; std_stdstringto_view(&__chx__lv__63, self); &__chx__lv__63; }))); &__chx__lv__62; }));
	return;
}
void std_stdstringto_u32(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__9 __chx__lv__64; std_stdstring_viewto_u32(&__chx__lv__64, &(*({ struct std_stdstring_view __chx__lv__65; std_stdstringto_view(&__chx__lv__65, self); &__chx__lv__65; }))); &__chx__lv__64; }));
	return;
}
void std_stdstringto_u64(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__10 __chx__lv__66; std_stdstring_viewto_u64(&__chx__lv__66, &(*({ struct std_stdstring_view __chx__lv__67; std_stdstringto_view(&__chx__lv__67, self); &__chx__lv__67; }))); &__chx__lv__66; }));
	return;
}
void std_stdstringto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__12 __chx__lv__68; std_stdstring_viewto_int(&__chx__lv__68, &(*({ struct std_stdstring_view __chx__lv__69; std_stdstringto_view(&__chx__lv__69, self); &__chx__lv__69; }))); &__chx__lv__68; }));
	return;
}
void std_stdstringto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__14 __chx__lv__70; std_stdstring_viewto_uint(&__chx__lv__70, &(*({ struct std_stdstring_view __chx__lv__71; std_stdstringto_view(&__chx__lv__71, self); &__chx__lv__71; }))); &__chx__lv__70; }));
	return;
}
void std_stdstringto_float(struct std_stdResult__cgs__17* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	char* end = NULL;
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__72; std_stdstring_viewconstructor(&__chx__lv__72, "invalid format", 14); &__chx__lv__72; }))
		};
		return;
	}
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__73; std_stdstring_viewconstructor(&__chx__lv__73, "trailing characters", 19); &__chx__lv__73; }))
		};
		return;
	}
...
void std_stdstringto_double(struct std_stdResult__cgs__19* __chx_struct_ret_param_xx, struct std_stdstring*const self){
	...
	if((end == std_stdstringdata(self))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__74; std_stdstring_viewconstructor(&__chx__lv__74, "invalid format", 14); &__chx__lv__74; }))
		};
		return;
	}
	while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
	...
	if(((end != NULL) && (*end != '\0'))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__75; std_stdstring_viewconstructor(&__chx__lv__75, "trailing characters", 19); &__chx__lv__75; }))
		};
		return;
	}
...
void std_stdstring_viewsubview(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t start, size_t end){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__77; std_stdstring_viewconstructor(&__chx__lv__77, (self->_data + start), (end - start)); &__chx__lv__77; }));
	return;
}
void std_stdstring_viewskip(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, size_t count){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__78; std_stdstring_viewconstructor(&__chx__lv__78, (self->_data + count), (self->_size - count)); &__chx__lv__78; }));
	return;
}
size_t std_stdstring_viewfind(struct std_stdstring_view*const self, struct std_stdstring_view*const needle){
...
void std_stdstring_viewtrim(struct std_stdstring_view* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((s == self->_size)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__79; std_stdstring_viewconstructor(&__chx__lv__79, "", 0); &__chx__lv__79; }));
		return;
	}
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring_view __chx__lv__80; std_stdstring_viewsubview(&__chx__lv__80, self, s, (e + 1)); &__chx__lv__80; }));
	return;
}
void std_stdstring_viewto_i8(struct std_stdResult__cgs__1* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__81; std_stdstring_viewto_i64(&__chx__lv__81, self); &__chx__lv__81; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__1) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int8_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__82; std_stdstring_viewto_i64(&__chx__lv__82, self); &__chx__lv__82; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__1) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__83; std_stdstring_viewto_i64(&__chx__lv__83, self); &__chx__lv__83; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i16(struct std_stdResult__cgs__2* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__84; std_stdstring_viewto_i64(&__chx__lv__84, self); &__chx__lv__84; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__2) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int16_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__85; std_stdstring_viewto_i64(&__chx__lv__85, self); &__chx__lv__85; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__2) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__86; std_stdstring_viewto_i64(&__chx__lv__86, self); &__chx__lv__86; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i32(struct std_stdResult__cgs__3* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__6 __chx__lv__87; std_stdstring_viewto_i64(&__chx__lv__87, self); &__chx__lv__87; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int32_t) ((*({ struct std_stdResult__cgs__6 __chx__lv__88; std_stdstring_viewto_i64(&__chx__lv__88, self); &__chx__lv__88; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__3) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__6 __chx__lv__89; std_stdstring_viewto_i64(&__chx__lv__89, self); &__chx__lv__89; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_i64(struct std_stdResult__cgs__6* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__90; std_stdstring_viewconstructor(&__chx__lv__90, "empty string", 12); &__chx__lv__90; }))
		};
		return;
	}
	if((self->_data[i] == '-')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__91; std_stdstring_viewconstructor(&__chx__lv__91, "invalid format", 14); &__chx__lv__91; }))
		};
		return;
	}
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__6) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__92; std_stdstring_viewconstructor(&__chx__lv__92, "trailing characters", 19); &__chx__lv__92; }))
		};
		return;
	}
...
void std_stdstring_viewto_u8(struct std_stdResult__cgs__7* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__10 __chx__lv__93; std_stdstring_viewto_u64(&__chx__lv__93, self); &__chx__lv__93; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__7) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint8_t) ((*({ struct std_stdResult__cgs__10 __chx__lv__94; std_stdstring_viewto_u64(&__chx__lv__94, self); &__chx__lv__94; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__7) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__10 __chx__lv__95; std_stdstring_viewto_u64(&__chx__lv__95, self); &__chx__lv__95; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u16(struct std_stdResult__cgs__8* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__10 __chx__lv__96; std_stdstring_viewto_u64(&__chx__lv__96, self); &__chx__lv__96; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint16_t) ((*({ struct std_stdResult__cgs__10 __chx__lv__97; std_stdstring_viewto_u64(&__chx__lv__97, self); &__chx__lv__97; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__8) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__10 __chx__lv__98; std_stdstring_viewto_u64(&__chx__lv__98, self); &__chx__lv__98; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u32(struct std_stdResult__cgs__9* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__10 __chx__lv__99; std_stdstring_viewto_u64(&__chx__lv__99, self); &__chx__lv__99; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 0, 
				.Ok.value = ((uint32_t) ((*({ struct std_stdResult__cgs__10 __chx__lv__100; std_stdstring_viewto_u64(&__chx__lv__100, self); &__chx__lv__100; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__9) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__10 __chx__lv__101; std_stdstring_viewto_u64(&__chx__lv__101, self); &__chx__lv__101; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_u64(struct std_stdResult__cgs__10* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	...
	if((i == self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__102; std_stdstring_viewconstructor(&__chx__lv__102, "empty string", 12); &__chx__lv__102; }))
		};
		return;
	}
	if((self->_data[i] == '+')){
	...
	if(((i == self->_size) || !isdigit(self->_data[i]))){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__103; std_stdstring_viewconstructor(&__chx__lv__103, "invalid format", 14); &__chx__lv__103; }))
		};
		return;
	}
	while(((i < self->_size) && isdigit(self->_data[i]))) {
	...
	if((i < self->_size)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__10) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__104; std_stdstring_viewconstructor(&__chx__lv__104, "trailing characters", 19); &__chx__lv__104; }))
		};
		return;
	}
...
void std_stdstring_viewto_int(struct std_stdResult__cgs__12* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__3 __chx__lv__105; std_stdstring_viewto_i32(&__chx__lv__105, self); &__chx__lv__105; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 0, 
				.Ok.value = ((int) ((*({ struct std_stdResult__cgs__3 __chx__lv__106; std_stdstring_viewto_i32(&__chx__lv__106, self); &__chx__lv__106; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__12) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__3 __chx__lv__107; std_stdstring_viewto_i32(&__chx__lv__107, self); &__chx__lv__107; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_uint(struct std_stdResult__cgs__14* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	switch(((*({ struct std_stdResult__cgs__9 __chx__lv__108; std_stdstring_viewto_u32(&__chx__lv__108, self); &__chx__lv__108; }))).__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 0, 
				.Ok.value = ((unsigned int) ((*({ struct std_stdResult__cgs__9 __chx__lv__109; std_stdstring_viewto_u32(&__chx__lv__109, self); &__chx__lv__109; }))).Ok.value)
			};
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__14) { .__chx__vt_621827 = 1, 
				.Err.error = ((*({ struct std_stdResult__cgs__9 __chx__lv__110; std_stdstring_viewto_u32(&__chx__lv__110, self); &__chx__lv__110; }))).Err.error
			};
			return;
			break;
		}
...
void std_stdstring_viewto_float(struct std_stdResult__cgs__17* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__111; std_stdstring_viewconstructor(&__chx__lv__111, "empty string", 12); &__chx__lv__111; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__112; std_stdstring_viewconstructor(&__chx__lv__112, "invalid format", 14); &__chx__lv__112; }))
			};
			return;
		}
		while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__113; std_stdstring_viewconstructor(&__chx__lv__113, "trailing characters", 19); &__chx__lv__113; }))
			};
			return;
		}
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__17) { .__chx__vt_621827 = 0, 
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__114; std_stdstringview_make(&__chx__lv__114, self); &__chx__lv__114; }));
	_Bool __chx__lv__115 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__17 __chx__lv__116; std_stdstringto_float(&__chx__lv__116, &s); &__chx__lv__116; }));
	if(__chx__lv__115) {
...
void std_stdstring_viewto_double(struct std_stdResult__cgs__19* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	if((self->_size == 0)){
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 1, 
			.Err.error = (*({ struct std_stdstring_view __chx__lv__117; std_stdstring_viewconstructor(&__chx__lv__117, "empty string", 12); &__chx__lv__117; }))
		};
		return;
	}
	if((self->_size < 128)){
		...
		if((end == ((char*) &buf[0]))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__118; std_stdstring_viewconstructor(&__chx__lv__118, "invalid format", 14); &__chx__lv__118; }))
			};
			return;
		}
		while((((end != NULL) && (*end != '\0')) && isspace(((int) *end)))) {
		...
		if(((end != NULL) && (*end != '\0'))){
			*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 1, 
				.Err.error = (*({ struct std_stdstring_view __chx__lv__119; std_stdstring_viewconstructor(&__chx__lv__119, "trailing characters", 19); &__chx__lv__119; }))
			};
			return;
		}
		*__chx_struct_ret_param_xx = (struct std_stdResult__cgs__19) { .__chx__vt_621827 = 0, 
	...
	struct std_stdstring s = (*({ struct std_stdstring __chx__lv__120; std_stdstringview_make(&__chx__lv__120, self); &__chx__lv__120; }));
	_Bool __chx__lv__121 = true;
	*__chx_struct_ret_param_xx = (*({ struct std_stdResult__cgs__19 __chx__lv__122; std_stdstringto_double(&__chx__lv__122, &s); &__chx__lv__122; }));
	if(__chx__lv__121) {
		std_stdstringdelete(&s);
	}
	return;
...
void std_stdstring_viewsplit(struct std_stdvector__cgs__0* __chx_struct_ret_param_xx, struct std_stdstring_view*const self, char delim){
	struct std_stdvector__cgs__0 res = (*({ struct std_stdvector__cgs__0 __chx__lv__123; std_stdvector__cgs__0make(&__chx__lv__123); &__chx__lv__123; }));
	_Bool __chx__lv__124 = true;
	unsigned int start = 0;
	for(unsigned int i = 0;(i < self->_size);i++){
		if((std_stdstring_viewget(self, i) == delim)){
			std_stdvector__cgs__0push(&res, &(*({ struct std_stdstring_view __chx__lv__125; std_stdstring_viewsubview(&__chx__lv__125, self, start, i); &__chx__lv__125; })));
			start = (i + 1);
		}
	}
	if((start <= self->_size)){
		std_stdvector__cgs__0push(&res, &(*({ struct std_stdstring_view __chx__lv__126; std_stdstring_viewsubview(&__chx__lv__126, self, start, self->_size); &__chx__lv__126; })));
	}
	*__chx_struct_ret_param_xx = res;
	return;
}
void std_stdstring_viewto_string(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring_view*const self){
	*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__127; std_stdstringview_make(&__chx__lv__127, self); &__chx__lv__127; }));
	return;
}
void std_stdstring_viewstream(struct std_stdstring_view*const self, struct std_stdStringStream* s){
...
void std_stdchronoDurationmul_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	...
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__128; std_stdchronoDurationfrom_nanos(&__chx__lv__128, result_nanos); &__chx__lv__128; }));
	return;
}
void std_stdchronoDurationdiv_i64(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self, int64_t scalar){
	if((scalar == 0)){
	...
	int64_t total_nanos = std_stdchronoDurationas_nanos(self);
	int64_t result_nanos = (total_nanos / scalar);
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__129; std_stdchronoDurationfrom_nanos(&__chx__lv__129, result_nanos); &__chx__lv__129; }));
	return;
}
void std_stdchronoDurationabs(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoDuration*const self){
	if((self->secs < 0)){
		*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__130; std_stdchronoDurationneg(&__chx__lv__130, self); &__chx__lv__130; }));
		return;
	}
	*__chx_struct_ret_param_xx = (struct std_stdchronoDuration){ 
		.secs = self->secs, 
...
void std_stdchronoInstantduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__131; std_stdchronoDurationfrom_parts(&__chx__lv__131, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__131; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoInstantelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self){
	struct std_stdchronoInstant now_inst = (*({ struct std_stdchronoInstant __chx__lv__132; std_stdchronoInstantnow(&__chx__lv__132); &__chx__lv__132; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__133; std_stdchronoInstantduration_since(&__chx__lv__133, &now_inst, self); &__chx__lv__133; }));
	return;
}
void std_stdchronoInstantduration_to(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoInstant*const later){
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__134; std_stdchronoInstantduration_since(&__chx__lv__134, later, self); &__chx__lv__134; }));
	return;
}
void std_stdchronoInstantadd_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__135; std_stdchronoDurationfrom_parts(&__chx__lv__135, self->secs, self->nanos); &__chx__lv__135; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__136; std_stdchronoDurationadd(&__chx__lv__136, &d, dur); &__chx__lv__136; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoInstantsub_duration(struct std_stdchronoInstant* __chx_struct_ret_param_xx, struct std_stdchronoInstant*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__137; std_stdchronoDurationfrom_parts(&__chx__lv__137, self->secs, self->nanos); &__chx__lv__137; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__138; std_stdchronoDurationsub(&__chx__lv__138, &d, dur); &__chx__lv__138; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoInstant){ 
...
void std_stdchronoSystemTimefrom_unix_epoch_nanos(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, int64_t secs, int64_t nanos){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__139; std_stdchronoDurationfrom_parts(&__chx__lv__139, secs, nanos); &__chx__lv__139; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
...
void std_stdchronoSystemTimeduration_since(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoSystemTime*const earlier){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__140; std_stdchronoDurationfrom_parts(&__chx__lv__140, (self->secs - earlier->secs), (self->nanos - earlier->nanos)); &__chx__lv__140; }));
	*__chx_struct_ret_param_xx = d;
	return;
}
void std_stdchronoSystemTimeelapsed(struct std_stdchronoDuration* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self){
	struct std_stdchronoSystemTime now_st = (*({ struct std_stdchronoSystemTime __chx__lv__141; std_stdchronoSystemTimenow(&__chx__lv__141); &__chx__lv__141; }));
	*__chx_struct_ret_param_xx = (*({ struct std_stdchronoDuration __chx__lv__142; std_stdchronoSystemTimeduration_since(&__chx__lv__142, &now_st, self); &__chx__lv__142; }));
	return;
}
void std_stdchronoSystemTimeadd_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__143; std_stdchronoDurationfrom_parts(&__chx__lv__143, self->secs, self->nanos); &__chx__lv__143; }));
	struct std_stdchronoDuration sum = (*({ struct std_stdchronoDuration __chx__lv__144; std_stdchronoDurationadd(&__chx__lv__144, &d, dur); &__chx__lv__144; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&sum), 
		.nanos = std_stdchronoDurationsubsec_nanos(&sum)
	};
...
void std_stdchronoSystemTimesub_duration(struct std_stdchronoSystemTime* __chx_struct_ret_param_xx, struct std_stdchronoSystemTime*const self, struct std_stdchronoDuration*const dur){
	struct std_stdchronoDuration d = (*({ struct std_stdchronoDuration __chx__lv__145; std_stdchronoDurationfrom_parts(&__chx__lv__145, self->secs, self->nanos); &__chx__lv__145; }));
	struct std_stdchronoDuration diff = (*({ struct std_stdchronoDuration __chx__lv__146; std_stdchronoDurationsub(&__chx__lv__146, &d, dur); &__chx__lv__146; }));
	*__chx_struct_ret_param_xx = (struct std_stdchronoSystemTime){ 
		.secs = std_stdchronoDurationas_secs(&diff), 
		.nanos = std_stdchronoDurationsubsec_nanos(&diff)
	};
...
static void std_stdOsStringmake(struct std_stdOsString* this, std_stdnative_string_t* str){
	...
	*this = (struct std_stdOsString){ 
		.data_ = ({ __chx__lv__147 = false; *str; })
	};
	if(__chx__lv__147) {
...
static void std_stdOsStringmake2(struct std_stdOsString* this, struct std_stdstring*const utf8){
	...
	*this = (struct std_stdOsString){ 
		.data_ = (*({ struct std_stdstring __chx__lv__148; std_stdstringcopy(&__chx__lv__148, utf8); &__chx__lv__148; }))
	};
	return;
}
static void std_stdOsStringfrom_utf8(struct std_stdOsString* __chx_struct_ret_param_xx, struct std_stdstring*const utf8){
	*__chx_struct_ret_param_xx = (*({ struct std_stdOsString __chx__lv__149; std_stdOsStringmake2(&__chx__lv__149, utf8); &__chx__lv__149; }));
	return;
}
static size_t std_stdOsStringsize(struct std_stdOsString*const self){
...
static void __chemda_260_0(void* this){
}
cstd_usize std_stdconcurrenthardware_threads(){
...
static const void* std_stdconcurrentworker_main(const void* arg){
	...
	while(1) {
		...
		if((std_stdvector__cgs__1size(&P->q) > 0)){
			...
			struct std_stdconcurrentTask t = (*({ struct std_stdconcurrentTask __chx__lv__151; std_stdreplace__cfg_0(&__chx__lv__151, &*first_ele, &(struct std_stdconcurrentTask){ 
				.f = *({ __chemical_fat_pointer__* __chemda_260_0_pair = &(__chemical_fat_pointer__){__chemda_260_0,NULL}; &(*({ struct std_stddefault_function_instance __chx__lv__152; std_stddefault_function_instancemake2(&__chx__lv__152, __chemda_260_0_pair->first, __chemda_260_0_pair->second, ((std_stddestructor_type) NULL), 0, 0); &__chx__lv__152; })); })
			}); &__chx__lv__151; }));
		...
		if((opt.__chx__vt_621827 == 0)){
			struct std_stdOption__cgs__1* __chx__lv__153 = &opt;
			({ struct std_stddefault_function_instance* __chx__lv__154 = &__chx__lv__153->Some.value.f; ((void(*)(void*))std_stddefault_function_instanceget_fn_ptr(__chx__lv__154))(std_stddefault_function_instanceget_data_ptr(__chx__lv__154)); });
		}
	}
	return NULL;
}
void std_stdconcurrentPoolDatasubmit_void(struct std_stdconcurrentPoolData* self, std_stdfunction* f){
	_Bool __chx__lv__155 = true;
	std_stdmutexlock(&self->m);
	std_stdvector__cgs__1push_back(&self->q, &(struct std_stdconcurrentTask){ 
		.f = ({ __chx__lv__155 = false; *f; })
	});
...
void std_stdconcurrentThreadPoolsubmit_void(struct std_stdconcurrentThreadPool*const self, std_stdfunction* f){
	...
	std_stdconcurrentPoolDatasubmit_void(self->data, ({ __chx__lv__156 = false; &*f; }));
	if(__chx__lv__156) {
		std_stddefault_function_instancedelete(f);
	}
}
void std_stdconcurrentThreadPooldelete(struct std_stdconcurrentThreadPool*const self){
	struct std_stdconcurrentPoolData*__chx__lv__157 = self->data;
	
	std_stdconcurrentPoolDatadelete(__chx__lv__157);
	free(__chx__lv__157);
	__chx__dstctr_clnup_blk__:{
	}
}
void std_stdconcurrentcreate_pool(struct std_stdconcurrentThreadPool* __chx_struct_ret_param_xx, unsigned int n){
	...
	({ struct std_stdconcurrentPoolData* __chx__lv__158 = p; *__chx__lv__158 = (struct std_stdconcurrentPoolData){ 
		.m = (*({ struct std_stdmutex __chx__lv__159; std_stdmutexconstructor(&__chx__lv__159); &__chx__lv__159; })), 
		.cv = (*({ struct std_stdCondVar __chx__lv__160; std_stdCondVarconstructor(&__chx__lv__160); &__chx__lv__160; })), 
		.q = (*({ struct std_stdvector__cgs__1 __chx__lv__161; std_stdvector__cgs__1make(&__chx__lv__161); &__chx__lv__161; })), 
		.workers = (*({ struct std_stdvector__cgs__2 __chx__lv__162; std_stdvector__cgs__2make(&__chx__lv__162); &__chx__lv__162; })), 
		.run = 1
	}; __chx__lv__158; });
	unsigned int i = 0;
	while((i < n)) {
