...
void path_pathparent(struct std_stdstring* __chx_struct_ret_param_xx, struct std_stdstring_view* sv){
	struct std_stdstring result = (*({ struct std_stdstring __chx__lv__0; std_stdstringempty_str(&__chx__lv__0); &__chx__lv__0; }));
...
void path_pathPathErrormessage(struct std_stdstring* __chx_struct_ret_param_xx, struct path_pathPathError*const self){
	switch((self)->__chx__vt_621827) {
		case 0:{
			*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__2; std_stdstringconstructor2(&__chx__lv__2, "PathError: output buffer too small", 34, 0); &__chx__lv__2; }));
			return;
			break;
		}
		case 1:{
			*__chx_struct_ret_param_xx = (*({ struct std_stdstring __chx__lv__3; std_stdstringconstructor2(&__chx__lv__3, "PathError: too many path components", 35, 0); &__chx__lv__3; }));
			return;
			break;
		}
		case 2:{
			struct std_stdstring s = (*({ struct std_stdstring __chx__lv__4; std_stdstringconstructor2(&__chx__lv__4, "PathError: invalid path: ", 25, 0); &__chx__lv__4; }));
