func resolve_page_children(
    ...
    if(appendHeadJsCharFn == null) {
        resolver.error("'append_js_char' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsCharPtrFn = page.child("append_js_char_ptr")
    if(appendHeadJsCharPtrFn == null) {
        resolver.error("'append_js_char_ptr' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsFn = page.child("append_js");
    if(appendHeadJsFn == null) {
        resolver.error("'append_js' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsIntFn = page.child("append_js_integer");
    if(appendHeadJsIntFn == null) {
        resolver.error("'append_js_integer' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsUIntFn = page.child("append_js_uinteger");
    if(appendHeadJsUIntFn == null) {
        resolver.error("'append_js_uinteger' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsFloatFn = page.child("append_js_float");
    if(appendHeadJsFloatFn == null) {
        resolver.error("'append_js_float' function is required on 'page' for html to work");
        return false;
    }

    const appendHeadJsDoubleFn = page.child("append_js_double");
    if(appendHeadJsDoubleFn == null) {
        resolver.error("'append_js_double' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlFn = page.child("append_html");
    if(appendHtmlFn == null) {
        resolver.error("'append_html' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlCharFn = page.child("append_html_char");
    if(appendHtmlCharFn == null) {
        resolver.error("'append_html_char' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlCharPtrFn = page.child("append_html_char_ptr");
    if(appendHtmlCharPtrFn == null) {
        resolver.error("'append_html_char_ptr' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlIntFn = page.child("append_html_integer");
    if(appendHtmlIntFn == null) {
        resolver.error("'append_html_integer' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlUIntFn = page.child("append_html_uinteger");
    if(appendHtmlUIntFn == null) {
        resolver.error("'append_html_uinteger' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlFloatFn = page.child("append_html_float");
    if(appendHtmlFloatFn == null) {
        resolver.error("'append_html_float' function is required on 'page' for html to work");
        return false;
    }

    const appendHtmlDoubleFn = page.child("append_html_double");
    if(appendHtmlDoubleFn == null) {
        resolver.error("'append_html_double' function is required on 'page' for html to work");
        return false;
    }

    const requireComponentFn = page.child("require_component");
    if(requireComponentFn == null) {
        resolver.error("'require_component' function is required on 'page' for html to work");
        return false;
    }

    const setComponentHashFn = page.child("set_component_hash");
    if(setComponentHashFn == null) {
        resolver.error("'set_component_hash' function is required on 'page' for html to work");
        return false;
    }
...
func sym_res_support(resolver : *mut SymbolResolver, support : &mut SymResSupport) : bool {
